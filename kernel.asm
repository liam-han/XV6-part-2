...
801009b1:	89 c3                	mov    %eax,%ebx

  begin_op();
801009b3:	e8 98 21 00 00       	call   80102b50 <begin_op>

  if((ip = namei(path)) == 0){
801009b8:	8b 45 08             	mov    0x8(%ebp),%eax
801009bb:	89 04 24             	mov    %eax,(%esp)
801009be:	e8 7d 15 00 00       	call   80101f40 <namei>
801009c3:	85 c0                	test   %eax,%eax
801009c5:	89 c7                	mov    %eax,%edi
801009c7:	0f 84 b3 01 00 00    	je     80100b80 <exec+0x1e0>
    end_op();
    cprintf("exec: fail\n");
    return -1;
  }
...
801009d0:	e8 1b 0d 00 00       	call   801016f0 <ilock>
  pgdir = 0;

  // Check ELF header
  if(readi(ip, (char*)&elf, 0, sizeof(elf)) != sizeof(elf))
801009d5:	8d 85 24 ff ff ff    	lea    -0xdc(%ebp),%eax
801009db:	c7 44 24 0c 34 00 00 	movl   $0x34,0xc(%esp)
801009e2:	00 
801009e3:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801009ea:	00 
801009eb:	89 44 24 04          	mov    %eax,0x4(%esp)
801009ef:	89 3c 24             	mov    %edi,(%esp)
801009f2:	e8 a9 0f 00 00       	call   801019a0 <readi>
801009f7:	83 f8 34             	cmp    $0x34,%eax
801009fa:	74 24                	je     80100a20 <exec+0x80>
 ...
 bad:
  ...
  if(ip){
    iunlockput(ip);
801009fc:	89 3c 24             	mov    %edi,(%esp)
801009ff:	e8 4c 0f 00 00       	call   80101950 <iunlockput>
    end_op();
80100a04:	e8 b7 21 00 00       	call   80102bc0 <end_op>
  }
  return -1;
80100a09:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
80100a0e:	81 c4 1c 01 00 00    	add    $0x11c,%esp
80100a14:	5b                   	pop    %ebx
80100a15:	5e                   	pop    %esi
80100a16:	5f                   	pop    %edi
80100a17:	5d                   	pop    %ebp
...
80100a27:	45 4c 46 
80100a2a:	75 d0                	jne    801009fc <exec+0x5c>
  if((pgdir = setupkvm()) == 0)
80100a2c:	e8 0f 60 00 00       	call   80106a40 <setupkvm>
80100a31:	85 c0                	test   %eax,%eax
80100a33:	89 85 f4 fe ff ff    	mov    %eax,-0x10c(%ebp)
80100a39:	74 c1                	je     801009fc <exec+0x5c>
  if((sz = allocuvm(pgdir, 0, PGSIZE)) == 0)
80100a3b:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80100a42:	00 
80100a43:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80100a4a:	00 
80100a4b:	89 04 24             	mov    %eax,(%esp)
80100a4e:	e8 4d 5e 00 00       	call   801068a0 <allocuvm>
80100a53:	85 c0                	test   %eax,%eax
80100a55:	89 85 f0 fe ff ff    	mov    %eax,-0x110(%ebp)
80100a5b:	75 10                	jne    80100a6d <exec+0xcd>
    freevm(pgdir);
80100a5d:	8b 85 f4 fe ff ff    	mov    -0x10c(%ebp),%eax
80100a63:	89 04 24             	mov    %eax,(%esp)
80100a66:	e8 55 5f 00 00       	call   801069c0 <freevm>
80100a6b:	eb 8f                	jmp    801009fc <exec+0x5c>
  clearpteu(pgdir, (char*)(sz - PGSIZE));
80100a6d:	2d 00 10 00 00       	sub    $0x1000,%eax
80100a72:	89 44 24 04          	mov    %eax,0x4(%esp)
80100a76:	8b 85 f4 fe ff ff    	mov    -0x10c(%ebp),%eax
80100a7c:	89 04 24             	mov    %eax,(%esp)
80100a7f:	e8 6c 60 00 00       	call   80106af0 <clearpteu>
  for(i=0, off=elf.phoff; i<elf.phnum; i++, off+=sizeof(ph)){
80100a84:	8b b5 40 ff ff ff    	mov    -0xc0(%ebp),%esi
80100a8a:	66 83 bd 50 ff ff ff 	cmpw   $0x0,-0xb0(%ebp)
80100a91:	00 
80100a92:	0f 84 09 01 00 00    	je     80100ba1 <exec+0x201>
80100a98:	31 c0                	xor    %eax,%eax
80100a9a:	89 9d ec fe ff ff    	mov    %ebx,-0x114(%ebp)
80100aa0:	89 c3                	mov    %eax,%ebx
80100aa2:	eb 19                	jmp    80100abd <exec+0x11d>
80100aa4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80100aa8:	0f b7 85 50 ff ff ff 	movzwl -0xb0(%ebp),%eax
80100aaf:	83 c3 01             	add    $0x1,%ebx
80100ab2:	83 c6 20             	add    $0x20,%esi
80100ab5:	39 d8                	cmp    %ebx,%eax
80100ab7:	0f 8e de 00 00 00    	jle    80100b9b <exec+0x1fb>
    if(readi(ip, (char*)&ph, off, sizeof(ph)) != sizeof(ph))
80100abd:	8d 85 04 ff ff ff    	lea    -0xfc(%ebp),%eax
80100ac3:	c7 44 24 0c 20 00 00 	movl   $0x20,0xc(%esp)
80100aca:	00 
80100acb:	89 74 24 08          	mov    %esi,0x8(%esp)
80100acf:	89 44 24 04          	mov    %eax,0x4(%esp)
80100ad3:	89 3c 24             	mov    %edi,(%esp)
80100ad6:	e8 c5 0e 00 00       	call   801019a0 <readi>
80100adb:	83 f8 20             	cmp    $0x20,%eax
80100ade:	0f 85 79 ff ff ff    	jne    80100a5d <exec+0xbd>
    if(ph.type != ELF_PROG_LOAD)
80100ae4:	83 bd 04 ff ff ff 01 	cmpl   $0x1,-0xfc(%ebp)
80100aeb:	75 bb                	jne    80100aa8 <exec+0x108>
    if(ph.memsz < ph.filesz)
80100aed:	8b 85 18 ff ff ff    	mov    -0xe8(%ebp),%eax
80100af3:	3b 85 14 ff ff ff    	cmp    -0xec(%ebp),%eax
80100af9:	0f 82 5e ff ff ff    	jb     80100a5d <exec+0xbd>
    if(ph.vaddr + ph.memsz < ph.vaddr)
80100aff:	03 85 0c ff ff ff    	add    -0xf4(%ebp),%eax
80100b05:	0f 82 52 ff ff ff    	jb     80100a5d <exec+0xbd>
    if((sz = allocuvm(pgdir, sz, ph.vaddr + ph.memsz)) == 0)
80100b0b:	89 44 24 08          	mov    %eax,0x8(%esp)
80100b0f:	8b 85 f0 fe ff ff    	mov    -0x110(%ebp),%eax
80100b15:	89 44 24 04          	mov    %eax,0x4(%esp)
80100b19:	8b 85 f4 fe ff ff    	mov    -0x10c(%ebp),%eax
80100b1f:	89 04 24             	mov    %eax,(%esp)
80100b22:	e8 79 5d 00 00       	call   801068a0 <allocuvm>
80100b27:	85 c0                	test   %eax,%eax
80100b29:	89 85 f0 fe ff ff    	mov    %eax,-0x110(%ebp)
80100b2f:	0f 84 28 ff ff ff    	je     80100a5d <exec+0xbd>
    if(ph.vaddr % PGSIZE != 0)
80100b35:	8b 85 0c ff ff ff    	mov    -0xf4(%ebp),%eax
80100b3b:	a9 ff 0f 00 00       	test   $0xfff,%eax
80100b40:	0f 85 17 ff ff ff    	jne    80100a5d <exec+0xbd>
    if(loaduvm(pgdir, (char*)ph.vaddr, ip, ph.off, ph.filesz) < 0)
80100b46:	8b 95 14 ff ff ff    	mov    -0xec(%ebp),%edx
80100b4c:	89 44 24 04          	mov    %eax,0x4(%esp)
80100b50:	8b 85 f4 fe ff ff    	mov    -0x10c(%ebp),%eax
80100b56:	89 7c 24 08          	mov    %edi,0x8(%esp)
80100b5a:	89 54 24 10          	mov    %edx,0x10(%esp)
80100b5e:	8b 95 08 ff ff ff    	mov    -0xf8(%ebp),%edx
80100b64:	89 04 24             	mov    %eax,(%esp)
80100b67:	89 54 24 0c          	mov    %edx,0xc(%esp)
80100b6b:	e8 70 5c 00 00       	call   801067e0 <loaduvm>
80100b70:	85 c0                	test   %eax,%eax
80100b72:	0f 89 30 ff ff ff    	jns    80100aa8 <exec+0x108>
80100b78:	e9 e0 fe ff ff       	jmp    80100a5d <exec+0xbd>
80100b7d:	8d 76 00             	lea    0x0(%esi),%esi
    end_op();
80100b80:	e8 3b 20 00 00       	call   80102bc0 <end_op>
    cprintf("exec: fail\n");
80100b85:	c7 04 24 a1 6e 10 80 	movl   $0x80106ea1,(%esp)
80100b8c:	e8 bf fa ff ff       	call   80100650 <cprintf>
    return -1;
80100b91:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80100b96:	e9 73 fe ff ff       	jmp    80100a0e <exec+0x6e>
80100b9b:	8b 9d ec fe ff ff    	mov    -0x114(%ebp),%ebx
  iunlockput(ip);
80100ba1:	89 3c 24             	mov    %edi,(%esp)
80100ba4:	e8 a7 0d 00 00       	call   80101950 <iunlockput>
  end_op();
80100ba9:	e8 12 20 00 00       	call   80102bc0 <end_op>
  if((allocuvm(pgdir, user_top - PGSIZE, user_top)) == 0)
80100bae:	8b 85 f4 fe ff ff    	mov    -0x10c(%ebp),%eax
80100bb4:	c7 44 24 08 fc ff ff 	movl   $0x7ffffffc,0x8(%esp)
80100bbb:	7f 
80100bbc:	c7 44 24 04 fc ef ff 	movl   $0x7fffeffc,0x4(%esp)
80100bc3:	7f 
80100bc4:	89 04 24             	mov    %eax,(%esp)
80100bc7:	e8 d4 5c 00 00       	call   801068a0 <allocuvm>
80100bcc:	85 c0                	test   %eax,%eax
80100bce:	0f 84 94 00 00 00    	je     80100c68 <exec+0x2c8>
  for(argc = 0; argv[argc]; argc++) {
80100bd4:	8b 45 0c             	mov    0xc(%ebp),%eax
80100bd7:	8b 00                	mov    (%eax),%eax
80100bd9:	85 c0                	test   %eax,%eax
80100bdb:	0f 84 80 01 00 00    	je     80100d61 <exec+0x3c1>
80100be1:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80100be4:	be fc ff ff 7f       	mov    $0x7ffffffc,%esi
80100be9:	89 9d ec fe ff ff    	mov    %ebx,-0x114(%ebp)
80100bef:	8d 51 04             	lea    0x4(%ecx),%edx
80100bf2:	89 cf                	mov    %ecx,%edi
80100bf4:	31 c9                	xor    %ecx,%ecx
80100bf6:	89 fb                	mov    %edi,%ebx
80100bf8:	89 d7                	mov    %edx,%edi
80100bfa:	89 ca                	mov    %ecx,%edx
80100bfc:	eb 28                	jmp    80100c26 <exec+0x286>
80100bfe:	66 90                	xchg   %ax,%ax
    ustack[3+argc] = sp;
80100c00:	8b 95 f0 fe ff ff    	mov    -0x110(%ebp),%edx
80100c06:	8d 8d 58 ff ff ff    	lea    -0xa8(%ebp),%ecx
  for(argc = 0; argv[argc]; argc++) {
80100c0c:	89 fb                	mov    %edi,%ebx
80100c0e:	8b 07                	mov    (%edi),%eax
    ustack[3+argc] = sp;
80100c10:	89 b4 95 64 ff ff ff 	mov    %esi,-0x9c(%ebp,%edx,4)
  for(argc = 0; argv[argc]; argc++) {
80100c17:	83 c2 01             	add    $0x1,%edx
80100c1a:	85 c0                	test   %eax,%eax
80100c1c:	74 62                	je     80100c80 <exec+0x2e0>
80100c1e:	83 c7 04             	add    $0x4,%edi
    if(argc >= MAXARG)
80100c21:	83 fa 20             	cmp    $0x20,%edx
80100c24:	74 42                	je     80100c68 <exec+0x2c8>
    sp = (sp - (strlen(argv[argc]) + 1)) & ~3;
80100c26:	89 04 24             	mov    %eax,(%esp)
80100c29:	89 95 f0 fe ff ff    	mov    %edx,-0x110(%ebp)
80100c2f:	e8 dc 38 00 00       	call   80104510 <strlen>
80100c34:	f7 d0                	not    %eax
80100c36:	01 c6                	add    %eax,%esi
    if(copyout(pgdir, sp, argv[argc], strlen(argv[argc]) + 1) < 0)
80100c38:	8b 03                	mov    (%ebx),%eax
    sp = (sp - (strlen(argv[argc]) + 1)) & ~3;
80100c3a:	83 e6 fc             	and    $0xfffffffc,%esi
    if(copyout(pgdir, sp, argv[argc], strlen(argv[argc]) + 1) < 0)
80100c3d:	89 04 24             	mov    %eax,(%esp)
80100c40:	e8 cb 38 00 00       	call   80104510 <strlen>
80100c45:	83 c0 01             	add    $0x1,%eax
80100c48:	89 44 24 0c          	mov    %eax,0xc(%esp)
80100c4c:	8b 03                	mov    (%ebx),%eax
80100c4e:	89 74 24 04          	mov    %esi,0x4(%esp)
80100c52:	89 44 24 08          	mov    %eax,0x8(%esp)
80100c56:	8b 85 f4 fe ff ff    	mov    -0x10c(%ebp),%eax
80100c5c:	89 04 24             	mov    %eax,(%esp)
80100c5f:	e8 ac 60 00 00       	call   80106d10 <copyout>
80100c64:	85 c0                	test   %eax,%eax
80100c66:	79 98                	jns    80100c00 <exec+0x260>
    freevm(pgdir);
80100c68:	8b 85 f4 fe ff ff    	mov    -0x10c(%ebp),%eax
80100c6e:	89 04 24             	mov    %eax,(%esp)
80100c71:	e8 4a 5d 00 00       	call   801069c0 <freevm>
  return -1;
80100c76:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80100c7b:	e9 8e fd ff ff       	jmp    80100a0e <exec+0x6e>
80100c80:	8b 9d ec fe ff ff    	mov    -0x114(%ebp),%ebx
80100c86:	89 d0                	mov    %edx,%eax
  ustack[3+argc] = 0;
80100c88:	c7 84 85 64 ff ff ff 	movl   $0x0,-0x9c(%ebp,%eax,4)
80100c8f:	00 00 00 00 
  ustack[2] = sp - (argc+1)*4;  // argv pointer
80100c93:	89 f2                	mov    %esi,%edx
  ustack[1] = argc;
80100c95:	89 85 5c ff ff ff    	mov    %eax,-0xa4(%ebp)
  ustack[2] = sp - (argc+1)*4;  // argv pointer
80100c9b:	8d 04 85 04 00 00 00 	lea    0x4(,%eax,4),%eax
80100ca2:	29 c2                	sub    %eax,%edx
  sp -= (3+argc+1) * 4;
80100ca4:	83 c0 0c             	add    $0xc,%eax
80100ca7:	29 c6                	sub    %eax,%esi
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100ca9:	89 44 24 0c          	mov    %eax,0xc(%esp)
80100cad:	8b 85 f4 fe ff ff    	mov    -0x10c(%ebp),%eax
80100cb3:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80100cb7:	89 74 24 04          	mov    %esi,0x4(%esp)
...
80100cc5:	89 04 24             	mov    %eax,(%esp)
  ustack[2] = sp - (argc+1)*4;  // argv pointer
80100cc8:	89 95 60 ff ff ff    	mov    %edx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100cce:	e8 3d 60 00 00       	call   80106d10 <copyout>
80100cd3:	85 c0                	test   %eax,%eax
80100cd5:	78 91                	js     80100c68 <exec+0x2c8>
  for(last=s=path; *s; s++)
80100cd7:	8b 45 08             	mov    0x8(%ebp),%eax
80100cda:	0f b6 10             	movzbl (%eax),%edx
80100cdd:	84 d2                	test   %dl,%dl
80100cdf:	74 1a                	je     80100cfb <exec+0x35b>
80100ce1:	8b 4d 08             	mov    0x8(%ebp),%ecx
80100ce4:	83 c0 01             	add    $0x1,%eax
      last = s+1;
80100ce7:	80 fa 2f             	cmp    $0x2f,%dl
80100cea:	0f 44 c8             	cmove  %eax,%ecx
80100ced:	83 c0 01             	add    $0x1,%eax
  for(last=s=path; *s; s++)
80100cf0:	0f b6 50 ff          	movzbl -0x1(%eax),%edx
80100cf4:	84 d2                	test   %dl,%dl
80100cf6:	75 ef                	jne    80100ce7 <exec+0x347>
80100cf8:	89 4d 08             	mov    %ecx,0x8(%ebp)
  safestrcpy(curproc->name, last, sizeof(curproc->name));
80100cfb:	8b 45 08             	mov    0x8(%ebp),%eax
80100cfe:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80100d05:	00 
80100d06:	89 44 24 04          	mov    %eax,0x4(%esp)
80100d0a:	8d 43 6c             	lea    0x6c(%ebx),%eax
80100d0d:	89 04 24             	mov    %eax,(%esp)
80100d10:	e8 bb 37 00 00       	call   801044d0 <safestrcpy>
  curproc->pgdir = pgdir;
80100d15:	8b 85 f4 fe ff ff    	mov    -0x10c(%ebp),%eax
  oldpgdir = curproc->pgdir;
80100d1b:	8b 7b 04             	mov    0x4(%ebx),%edi
  curproc->sz = user_top;
80100d1e:	c7 03 fc ff ff 7f    	movl   $0x7ffffffc,(%ebx)
  curproc->stack_base = user_top;
80100d24:	c7 43 7c fc ff ff 7f 	movl   $0x7ffffffc,0x7c(%ebx)
  curproc->pgdir = pgdir;
80100d2b:	89 43 04             	mov    %eax,0x4(%ebx)
  curproc->tf->eip = elf.entry;  // main
80100d2e:	8b 43 18             	mov    0x18(%ebx),%eax
80100d31:	8b 95 3c ff ff ff    	mov    -0xc4(%ebp),%edx
80100d37:	89 50 38             	mov    %edx,0x38(%eax)
  curproc->tf->esp = sp;
80100d3a:	8b 43 18             	mov    0x18(%ebx),%eax
80100d3d:	89 70 44             	mov    %esi,0x44(%eax)
  curproc->page_stack_num = 1; //set number of pages made to 1
80100d40:	c7 83 80 00 00 00 01 	movl   $0x1,0x80(%ebx)
80100d47:	00 00 00 
  switchuvm(curproc);
80100d4a:	89 1c 24             	mov    %ebx,(%esp)
80100d4d:	e8 ee 58 00 00       	call   80106640 <switchuvm>
  freevm(oldpgdir);
80100d52:	89 3c 24             	mov    %edi,(%esp)
80100d55:	e8 66 5c 00 00       	call   801069c0 <freevm>
  return 0;
80100d5a:	31 c0                	xor    %eax,%eax
80100d5c:	e9 ad fc ff ff       	jmp    80100a0e <exec+0x6e>
  for(argc = 0; argv[argc]; argc++) {
80100d61:	be fc ff ff 7f       	mov    $0x7ffffffc,%esi
80100d66:	31 c0                	xor    %eax,%eax
80100d68:	8d 8d 58 ff ff ff    	lea    -0xa8(%ebp),%ecx
80100d6e:	e9 15 ff ff ff       	jmp    80100c88 <exec+0x2e8>
...
80100d86:	c7 44 24 04 ad 6e 10 	movl   $0x80106ead,0x4(%esp)
80100d8d:	80 
...
80100e46:	c3                   	ret    
    panic("filedup");
80100e47:	c7 04 24 b4 6e 10 80 	movl   $0x80106eb4,(%esp)
...
80100f07:	e9 b4 1c 00 00       	jmp    80102bc0 <end_op>
    panic("fileclose");
80100f0c:	c7 04 24 bc 6e 10 80 	movl   $0x80106ebc,(%esp)
...
80100ff5:	eb d8                	jmp    80100fcf <fileread+0x5f>
  panic("fileread");
80100ff7:	c7 04 24 c6 6e 10 80 	movl   $0x80106ec6,(%esp)
...
8010110c:	e9 1f 22 00 00       	jmp    80103330 <pipewrite>
        panic("short filewrite");
80101111:	c7 04 24 cf 6e 10 80 	movl   $0x80106ecf,(%esp)
80101118:	e8 43 f2 ff ff       	call   80100360 <panic>
  panic("filewrite");
8010111d:	c7 04 24 d5 6e 10 80 	movl   $0x80106ed5,(%esp)
...
801011d5:	c7 04 24 df 6e 10 80 	movl   $0x80106edf,(%esp)
...
801012fd:	c7 04 24 f5 6e 10 80 	movl   $0x80106ef5,(%esp)
...
801013b5:	eb 93                	jmp    8010134a <bmap+0x3a>
  panic("bmap: out of range");
801013b7:	c7 04 24 05 6f 10 80 	movl   $0x80106f05,(%esp)
...
80101499:	c7 04 24 18 6f 10 80 	movl   $0x80106f18,(%esp)
...
801014bc:	c7 44 24 04 2b 6f 10 	movl   $0x80106f2b,0x4(%esp)
801014c3:	80 
...
801014d9:	c7 44 24 04 32 6f 10 	movl   $0x80106f32,0x4(%esp)
801014e0:	80 
...
80101506:	c7 04 24 98 6f 10 80 	movl   $0x80106f98,(%esp)
...
80101621:	c7 04 24 38 6f 10 80 	movl   $0x80106f38,(%esp)
...
801017a4:	0f 85 76 ff ff ff    	jne    80101720 <ilock+0x30>
      panic("ilock: no type");
801017aa:	c7 04 24 50 6f 10 80 	movl   $0x80106f50,(%esp)
801017b1:	e8 aa eb ff ff       	call   80100360 <panic>
    panic("ilock");
801017b6:	c7 04 24 4a 6f 10 80 	movl   $0x80106f4a,(%esp)
...
801017fe:	e9 4d 28 00 00       	jmp    80104050 <releasesleep>
    panic("iunlock");
80101803:	c7 04 24 5f 6f 10 80 	movl   $0x80106f5f,(%esp)
...
80101ca1:	c3                   	ret    
      panic("dirlookup read");
80101ca2:	c7 04 24 79 6f 10 80 	movl   $0x80106f79,(%esp)
80101ca9:	e8 b2 e6 ff ff       	call   80100360 <panic>
    panic("dirlookup not DIR");
80101cae:	c7 04 24 67 6f 10 80 	movl   $0x80106f67,(%esp)
...
80101f23:	eb e9                	jmp    80101f0e <dirlink+0xae>
      panic("dirlink read");
80101f25:	c7 04 24 88 6f 10 80 	movl   $0x80106f88,(%esp)
...
8010201f:	c7 04 24 f4 6f 10 80 	movl   $0x80106ff4,(%esp)
80102026:	e8 35 e3 ff ff       	call   80100360 <panic>
    panic("idestart");
8010202b:	c7 04 24 eb 6f 10 80 	movl   $0x80106feb,(%esp)
...
80102046:	c7 44 24 04 06 70 10 	movl   $0x80107006,0x4(%esp)
8010204d:	80 
...
80102219:	eb bb                	jmp    801021d6 <iderw+0x76>
    panic("iderw: buf not locked");
8010221b:	c7 04 24 0a 70 10 80 	movl   $0x8010700a,(%esp)
80102222:	e8 39 e1 ff ff       	call   80100360 <panic>
    panic("iderw: ide disk 1 not present");
80102227:	c7 04 24 35 70 10 80 	movl   $0x80107035,(%esp)
8010222e:	e8 2d e1 ff ff       	call   80100360 <panic>
    panic("iderw: nothing to do");
80102233:	c7 04 24 20 70 10 80 	movl   $0x80107020,(%esp)
...
80102288:	c7 04 24 54 70 10 80 	movl   $0x80107054,(%esp)
...
801023bc:	eb bb                	jmp    80102379 <kfree+0x49>
    panic("kfree");
801023be:	c7 04 24 86 70 10 80 	movl   $0x80107086,(%esp)
...
8010242b:	c7 44 24 04 8c 70 10 	movl   $0x8010708c,0x4(%esp)
80102432:	80 
...
80102de7:	e8 74 27 00 00       	call   80105560 <idtinit>
...
80102e13:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102e16:	e8 05 38 00 00       	call   80106620 <switchkvm>
  seginit();
80102e1b:	e8 c0 36 00 00       	call   801064e0 <seginit>
  lapicinit();
...
80102e53:	e8 78 3c 00 00       	call   80106ad0 <kvmalloc>
...
80102e65:	e8 76 36 00 00       	call   801064e0 <seginit>
  picinit();       // disable pic
...
80102e7a:	e8 01 2a 00 00       	call   80105880 <uartinit>
80102e7f:	90                   	nop
  pinit();         // process table
80102e80:	e8 9b 07 00 00       	call   80103620 <pinit>
  shminit();       // shared memory
80102e85:	e8 16 3f 00 00       	call   80106da0 <shminit>
  tvinit();        // trap vectors
80102e8a:	e8 31 26 00 00       	call   801054c0 <tvinit>
80102e8f:	90                   	nop
  binit();         // buffer cache
...
80103570:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103573:	c7 40 14 b5 54 10 80 	movl   $0x801054b5,0x14(%eax)
...
80103723:	e8 18 33 00 00       	call   80106a40 <setupkvm>
...
80103745:	80 
80103746:	e8 05 30 00 00       	call   80106750 <inituvm>
  p->sz = PGSIZE;
...
80103849:	e8 52 30 00 00       	call   801068a0 <allocuvm>
...
80103857:	e8 e4 2d 00 00       	call   80106640 <switchuvm>
  return 0;
...
8010387a:	e8 21 31 00 00       	call   801069a0 <deallocuvm>
...
801038ac:	0f 84 c4 00 00 00    	je     80103976 <fork+0xe6>
  if((np->pgdir = copyuvm(curproc->pgdir, curproc->sz, curproc->page_stack_num)) == 0){
801038b2:	8b 83 80 00 00 00    	mov    0x80(%ebx),%eax
801038b8:	89 44 24 08          	mov    %eax,0x8(%esp)
801038bc:	8b 03                	mov    (%ebx),%eax
801038be:	89 44 24 04          	mov    %eax,0x4(%esp)
801038c2:	8b 43 04             	mov    0x4(%ebx),%eax
801038c5:	89 04 24             	mov    %eax,(%esp)
801038c8:	e8 53 32 00 00       	call   80106b20 <copyuvm>
801038cd:	85 c0                	test   %eax,%eax
801038cf:	89 47 04             	mov    %eax,0x4(%edi)
801038d2:	0f 84 a5 00 00 00    	je     8010397d <fork+0xed>
  np->sz = curproc->sz;
801038d8:	8b 03                	mov    (%ebx),%eax
801038da:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
801038dd:	89 01                	mov    %eax,(%ecx)
  *np->tf = *curproc->tf;
801038df:	8b 79 18             	mov    0x18(%ecx),%edi
801038e2:	89 c8                	mov    %ecx,%eax
  np->parent = curproc;
801038e4:	89 59 14             	mov    %ebx,0x14(%ecx)
  *np->tf = *curproc->tf;
801038e7:	8b 73 18             	mov    0x18(%ebx),%esi
801038ea:	b9 13 00 00 00       	mov    $0x13,%ecx
801038ef:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  for(i = 0; i < NOFILE; i++)
801038f1:	31 f6                	xor    %esi,%esi
  np->tf->eax = 0;
801038f3:	8b 40 18             	mov    0x18(%eax),%eax
801038f6:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
...
801039f5:	81 c3 84 00 00 00    	add    $0x84,%ebx
      switchuvm(p);
801039fb:	e8 40 2c 00 00       	call   80106640 <switchuvm>
...
80103a11:	e8 15 0b 00 00       	call   8010452b <swtch>
      switchkvm();
80103a16:	e8 05 2c 00 00       	call   80106620 <switchkvm>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80103be9:	e8 52 fe ff ff       	call   80103a40 <sched>
  panic("zombie exit");
80103bee:	c7 04 24 fd 73 10 80 	movl   $0x801073fd,(%esp)
80103bf5:	e8 66 c7 ff ff       	call   80100360 <panic>
    panic("init exiting");
80103bfa:	c7 04 24 f0 73 10 80 	movl   $0x801073f0,(%esp)
...
80103cde:	c7 04 24 0f 74 10 80 	movl   $0x8010740f,(%esp)
80103ce5:	e8 76 c6 ff ff       	call   80100360 <panic>
    panic("sleep");
80103cea:	c7 04 24 09 74 10 80 	movl   $0x80107409,(%esp)
...
80103d90:	e8 2b 2c 00 00       	call   801069c0 <freevm>
        release(&ptable.lock);
...
80103ef4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80103ef8:	c7 04 24 9f 77 10 80 	movl   $0x8010779f,(%esp)
...
80103f1d:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80103f20:	ba 20 74 10 80       	mov    $0x80107420,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80103f25:	77 11                	ja     80103f38 <procdump+0x58>
80103f27:	8b 14 85 80 74 10 80 	mov    -0x7fef8b80(,%eax,4),%edx
      state = "???";
80103f2e:	b8 20 74 10 80       	mov    $0x80107420,%eax
...
80103f43:	c7 04 24 24 74 10 80 	movl   $0x80107424,(%esp)
...
80103f89:	c7 04 24 61 6e 10 80 	movl   $0x80106e61,(%esp)
...
80103fba:	c7 44 24 04 98 74 10 	movl   $0x80107498,0x4(%esp)
80103fc1:	80 
...
80104217:	eb ac                	jmp    801041c5 <acquire+0x15>
    panic("acquire");
80104219:	c7 04 24 a3 74 10 80 	movl   $0x801074a3,(%esp)
...
80104279:	c3                   	ret    
    panic("popcli");
8010427a:	c7 04 24 c2 74 10 80 	movl   $0x801074c2,(%esp)
80104281:	e8 da c0 ff ff       	call   80100360 <panic>
    panic("popcli - interruptible");
80104286:	c7 04 24 ab 74 10 80 	movl   $0x801074ab,(%esp)
...
801042af:	75 0f                	jne    801042c0 <release+0x20>
    panic("release");
801042b1:	c7 04 24 c9 74 10 80 	movl   $0x801074c9,(%esp)
...
80104546:	3d f8 ff ff 7f       	cmp    $0x7ffffff8,%eax
8010454b:	77 0b                	ja     80104558 <fetchint+0x18>
    return -1;
  *ip = *(int*)(addr);
8010454d:	8b 10                	mov    (%eax),%edx
8010454f:	8b 45 0c             	mov    0xc(%ebp),%eax
80104552:	89 10                	mov    %edx,(%eax)
  return 0;
...
80104567:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
8010456a:	e8 71 f1 ff ff       	call   801036e0 <myproc>
  if(addr >= USERTOP)
8010456f:	81 fb fb ff ff 7f    	cmp    $0x7ffffffb,%ebx
80104575:	77 25                	ja     8010459c <fetchstr+0x3c>
    return -1;
  *pp = (char*)addr;
80104577:	8b 4d 0c             	mov    0xc(%ebp),%ecx
8010457a:	89 da                	mov    %ebx,%edx
8010457c:	89 19                	mov    %ebx,(%ecx)
  ep = (char*)curproc->sz;
8010457e:	8b 00                	mov    (%eax),%eax
  for(s = *pp; s < ep; s++){
80104580:	39 c3                	cmp    %eax,%ebx
80104582:	73 18                	jae    8010459c <fetchstr+0x3c>
    if(*s == 0)
80104584:	80 3b 00             	cmpb   $0x0,(%ebx)
80104587:	75 0c                	jne    80104595 <fetchstr+0x35>
80104589:	eb 1d                	jmp    801045a8 <fetchstr+0x48>
8010458b:	90                   	nop
8010458c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104590:	80 3a 00             	cmpb   $0x0,(%edx)
80104593:	74 13                	je     801045a8 <fetchstr+0x48>
  for(s = *pp; s < ep; s++){
80104595:	83 c2 01             	add    $0x1,%edx
80104598:	39 d0                	cmp    %edx,%eax
8010459a:	77 f4                	ja     80104590 <fetchstr+0x30>
      return s - *pp;
  }
  return -1;
}
8010459c:	83 c4 04             	add    $0x4,%esp
    return -1;
8010459f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
801045a4:	5b                   	pop    %ebx
801045a5:	5d                   	pop    %ebp
801045a6:	c3                   	ret    
...
801045c6:	e8 15 f1 ff ff       	call   801036e0 <myproc>
801045cb:	8b 55 08             	mov    0x8(%ebp),%edx
801045ce:	8b 40 18             	mov    0x18(%eax),%eax
801045d1:	8b 40 44             	mov    0x44(%eax),%eax
801045d4:	8d 44 90 04          	lea    0x4(%eax,%edx,4),%eax
  if(addr >= USERTOP || addr+4 > USERTOP)
801045d8:	3d f8 ff ff 7f       	cmp    $0x7ffffff8,%eax
801045dd:	77 11                	ja     801045f0 <argint+0x30>
  *ip = *(int*)(addr);
801045df:	8b 10                	mov    (%eax),%edx
801045e1:	8b 45 0c             	mov    0xc(%ebp),%eax
...
80104604:	83 ec 24             	sub    $0x24,%esp
80104607:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
 
  if(argint(n, &i) < 0)
8010460a:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010460d:	89 44 24 04          	mov    %eax,0x4(%esp)
80104611:	8b 45 08             	mov    0x8(%ebp),%eax
80104614:	89 04 24             	mov    %eax,(%esp)
80104617:	e8 a4 ff ff ff       	call   801045c0 <argint>
8010461c:	85 c0                	test   %eax,%eax
8010461e:	78 28                	js     80104648 <argptr+0x48>
    return -1;
  if(size < 0 || (uint)i >= USERTOP || (uint)i+size > USERTOP)
80104620:	85 db                	test   %ebx,%ebx
80104622:	78 24                	js     80104648 <argptr+0x48>
80104624:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104627:	3d fb ff ff 7f       	cmp    $0x7ffffffb,%eax
8010462c:	77 1a                	ja     80104648 <argptr+0x48>
8010462e:	01 c3                	add    %eax,%ebx
80104630:	81 fb fc ff ff 7f    	cmp    $0x7ffffffc,%ebx
80104636:	77 10                	ja     80104648 <argptr+0x48>
    return -1;
  *pp = (char*)i;
...
8010463d:	83 c4 24             	add    $0x24,%esp
  return 0;
...
80104648:	83 c4 24             	add    $0x24,%esp
    return -1;
...
80104673:	e8 48 ff ff ff       	call   801045c0 <argint>
...
80104689:	e8 d2 fe ff ff       	call   80104560 <fetchstr>
}
8010468e:	c9                   	leave  
8010468f:	c3                   	ret    
    return -1;
...
801046a5:	83 ec 10             	sub    $0x10,%esp
  int num;
  struct proc *curproc = myproc();
801046a8:	e8 33 f0 ff ff       	call   801036e0 <myproc>
...
801046b8:	83 fa 16             	cmp    $0x16,%edx
801046bb:	77 1b                	ja     801046d8 <syscall+0x38>
801046bd:	8b 14 85 00 75 10 80 	mov    -0x7fef8b00(,%eax,4),%edx
...
801046e6:	c7 04 24 d1 74 10 80 	movl   $0x801074d1,(%esp)
...
80104716:	83 ec 04             	sub    $0x4,%esp
  int fd;
  struct proc *curproc = myproc();
80104719:	e8 c2 ef ff ff       	call   801036e0 <myproc>
...
8010476c:	89 4d bc             	mov    %ecx,-0x44(%ebp)
  if((dp = nameiparent(path, name)) == 0)
8010476f:	e8 ec d7 ff ff       	call   80101f60 <nameiparent>
...
80104781:	e8 6a cf ff ff       	call   801016f0 <ilock>
...
801047cb:	e8 80 d1 ff ff       	call   80101950 <iunlockput>
}
...
801047ed:	e8 6e cd ff ff       	call   80101560 <ialloc>
...
801047ff:	e8 ec ce ff ff       	call   801016f0 <ilock>
  ip->major = major;
...
80104820:	e8 0b ce ff ff       	call   80101630 <iupdate>
...
801048ea:	e8 d1 fc ff ff       	call   801045c0 <argint>
...
801048f9:	e8 e2 ed ff ff       	call   801036e0 <myproc>
...
80104969:	e8 a2 c4 ff ff       	call   80100e10 <filedup>
  return fd;
...
801049a2:	e8 19 fc ff ff       	call   801045c0 <argint>
...
801049dd:	e8 8e c5 ff ff       	call   80100f70 <fileread>
}
801049e2:	c9                   	leave  
801049e3:	c3                   	ret    
...
80104a12:	e8 a9 fb ff ff       	call   801045c0 <argint>
...
80104a4d:	e8 be c5 ff ff       	call   80101010 <filewrite>
}
80104a52:	c9                   	leave  
80104a53:	c3                   	ret    
...
80104a73:	78 23                	js     80104a98 <sys_close+0x38>
  myproc()->ofile[fd] = 0;
80104a75:	e8 66 ec ff ff       	call   801036e0 <myproc>
...
80104a8b:	e8 d0 c3 ff ff       	call   80100e60 <fileclose>
  return 0;
...
80104ae0:	e8 3b c4 ff ff       	call   80100f20 <filestat>
}
80104ae5:	c9                   	leave  
80104ae6:	c3                   	ret    
80104ae7:	90                   	nop
...
80104b29:	0f 88 cb 00 00 00    	js     80104bfa <sys_link+0x10a>
  begin_op();
80104b2f:	e8 1c e0 ff ff       	call   80102b50 <begin_op>
  if((ip = namei(old)) == 0){
80104b34:	8b 45 d4             	mov    -0x2c(%ebp),%eax
80104b37:	89 04 24             	mov    %eax,(%esp)
80104b3a:	e8 01 d4 ff ff       	call   80101f40 <namei>
...
80104b67:	e8 c4 ca ff ff       	call   80101630 <iupdate>
  iunlock(ip);
80104b6c:	89 1c 24             	mov    %ebx,(%esp)
80104b6f:	e8 5c cc ff ff       	call   801017d0 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80104b74:	8b 45 d0             	mov    -0x30(%ebp),%eax
80104b77:	89 7c 24 04          	mov    %edi,0x4(%esp)
80104b7b:	89 04 24             	mov    %eax,(%esp)
80104b7e:	e8 dd d3 ff ff       	call   80101f60 <nameiparent>
...
80104b8c:	e8 5f cb ff ff       	call   801016f0 <ilock>
...
80104ba5:	e8 b6 d2 ff ff       	call   80101e60 <dirlink>
80104baa:	85 c0                	test   %eax,%eax
80104bac:	78 22                	js     80104bd0 <sys_link+0xe0>
  iunlockput(dp);
80104bae:	89 34 24             	mov    %esi,(%esp)
80104bb1:	e8 9a cd ff ff       	call   80101950 <iunlockput>
  iput(ip);
80104bb6:	89 1c 24             	mov    %ebx,(%esp)
80104bb9:	e8 52 cc ff ff       	call   80101810 <iput>
  end_op();
80104bbe:	e8 fd df ff ff       	call   80102bc0 <end_op>
}
...
80104bd3:	e8 78 cd ff ff       	call   80101950 <iunlockput>
  ilock(ip);
80104bd8:	89 1c 24             	mov    %ebx,(%esp)
80104bdb:	e8 10 cb ff ff       	call   801016f0 <ilock>
  ip->nlink--;
80104be0:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
80104be5:	89 1c 24             	mov    %ebx,(%esp)
80104be8:	e8 43 ca ff ff       	call   80101630 <iupdate>
  iunlockput(ip);
80104bed:	89 1c 24             	mov    %ebx,(%esp)
80104bf0:	e8 5b cd ff ff       	call   80101950 <iunlockput>
  end_op();
80104bf5:	e8 c6 df ff ff       	call   80102bc0 <end_op>
}
...
80104c2e:	0f 88 76 01 00 00    	js     80104daa <sys_unlink+0x19a>
  begin_op();
80104c34:	e8 17 df ff ff       	call   80102b50 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
...
80104c46:	e8 15 d3 ff ff       	call   80101f60 <nameiparent>
...
80104c5c:	e8 8f ca ff ff       	call   801016f0 <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80104c61:	c7 44 24 04 7c 75 10 	movl   $0x8010757c,0x4(%esp)
80104c68:	80 
80104c69:	89 1c 24             	mov    %ebx,(%esp)
80104c6c:	e8 5f cf ff ff       	call   80101bd0 <namecmp>
80104c71:	85 c0                	test   %eax,%eax
80104c73:	0f 84 21 01 00 00    	je     80104d9a <sys_unlink+0x18a>
80104c79:	c7 44 24 04 7b 75 10 	movl   $0x8010757b,0x4(%esp)
80104c80:	80 
80104c81:	89 1c 24             	mov    %ebx,(%esp)
80104c84:	e8 47 cf ff ff       	call   80101bd0 <namecmp>
...
80104c9f:	e8 5c cf ff ff       	call   80101c00 <dirlookup>
...
80104cb1:	e8 3a ca ff ff       	call   801016f0 <ilock>
  if(ip->nlink < 1)
...
80104cde:	e8 0d f6 ff ff       	call   801042f0 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
...
80104cfc:	e8 9f cd ff ff       	call   80101aa0 <writei>
...
80104d1b:	e8 30 cc ff ff       	call   80101950 <iunlockput>
  ip->nlink--;
80104d20:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
80104d25:	89 1c 24             	mov    %ebx,(%esp)
80104d28:	e8 03 c9 ff ff       	call   80101630 <iupdate>
  iunlockput(ip);
80104d2d:	89 1c 24             	mov    %ebx,(%esp)
80104d30:	e8 1b cc ff ff       	call   80101950 <iunlockput>
  end_op();
80104d35:	e8 86 de ff ff       	call   80102bc0 <end_op>
}
...
80104d81:	e8 1a cc ff ff       	call   801019a0 <readi>
...
80104d95:	e8 b6 cb ff ff       	call   80101950 <iunlockput>
  iunlockput(dp);
80104d9a:	8b 45 b4             	mov    -0x4c(%ebp),%eax
80104d9d:	89 04 24             	mov    %eax,(%esp)
80104da0:	e8 ab cb ff ff       	call   80101950 <iunlockput>
  end_op();
80104da5:	e8 16 de ff ff       	call   80102bc0 <end_op>
}
...
80104dc3:	e8 68 c8 ff ff       	call   80101630 <iupdate>
80104dc8:	e9 48 ff ff ff       	jmp    80104d15 <sys_unlink+0x105>
      panic("isdirempty: readi");
80104dcd:	c7 04 24 a0 75 10 80 	movl   $0x801075a0,(%esp)
80104dd4:	e8 87 b5 ff ff       	call   80100360 <panic>
    panic("unlink: writei");
80104dd9:	c7 04 24 b2 75 10 80 	movl   $0x801075b2,(%esp)
80104de0:	e8 7b b5 ff ff       	call   80100360 <panic>
    panic("unlink: nlink < 1");
80104de5:	c7 04 24 8e 75 10 80 	movl   $0x8010758e,(%esp)
...
80104e32:	e8 89 f7 ff ff       	call   801045c0 <argint>
80104e37:	85 c0                	test   %eax,%eax
80104e39:	0f 88 b6 00 00 00    	js     80104ef5 <sys_open+0xf5>
    return -1;

  begin_op();
80104e3f:	e8 0c dd ff ff       	call   80102b50 <begin_op>
...
80104e54:	e8 e7 d0 ff ff       	call   80101f40 <namei>
...
80104e66:	e8 85 c8 ff ff       	call   801016f0 <ilock>
...
80104e76:	e8 25 bf ff ff       	call   80100da0 <filealloc>
...
80104e97:	e8 34 c9 ff ff       	call   801017d0 <iunlock>
  end_op();
80104e9c:	e8 1f dd ff ff       	call   80102bc0 <end_op>
...
80104f43:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_op();
80104f46:	e8 05 dc ff ff       	call   80102b50 <begin_op>
...
80104f7f:	e8 cc c9 ff ff       	call   80101950 <iunlockput>
  end_op();
80104f84:	e8 37 dc ff ff       	call   80102bc0 <end_op>
  return 0;
...
80104f8d:	8d 76 00             	lea    0x0(%esi),%esi
    end_op();
80104f90:	e8 2b dc ff ff       	call   80102bc0 <end_op>
    return -1;
...
80104fa3:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_op();
80104fa6:	e8 a5 db ff ff       	call   80102b50 <begin_op>
  if((argstr(0, &path)) < 0 ||
...
80104fd0:	e8 eb f5 ff ff       	call   801045c0 <argint>
  if((argstr(0, &path)) < 0 ||
...
80104fe7:	e8 d4 f5 ff ff       	call   801045c0 <argint>
     argint(1, &major) < 0 ||
...
8010500f:	e8 3c c9 ff ff       	call   80101950 <iunlockput>
  end_op();
80105014:	e8 a7 db ff ff       	call   80102bc0 <end_op>
  return 0;
...
8010501d:	8d 76 00             	lea    0x0(%esi),%esi
    end_op();
80105020:	e8 9b db ff ff       	call   80102bc0 <end_op>
    return -1;
...
80105035:	83 ec 20             	sub    $0x20,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105038:	e8 a3 e6 ff ff       	call   801036e0 <myproc>
8010503d:	89 c6                	mov    %eax,%esi
  
  begin_op();
8010503f:	e8 0c db ff ff       	call   80102b50 <begin_op>
...
80105061:	e8 da ce ff ff       	call   80101f40 <namei>
...
8010506f:	e8 7c c6 ff ff       	call   801016f0 <ilock>
  if(ip->type != T_DIR){
...
8010507c:	75 22                	jne    801050a0 <sys_chdir+0x70>
  ...
  iunlock(ip);
8010507e:	e8 4d c7 ff ff       	call   801017d0 <iunlock>
  iput(curproc->cwd);
80105083:	8b 46 68             	mov    0x68(%esi),%eax
80105086:	89 04 24             	mov    %eax,(%esp)
80105089:	e8 82 c7 ff ff       	call   80101810 <iput>
  end_op();
8010508e:	e8 2d db ff ff       	call   80102bc0 <end_op>
  curproc->cwd = ip;
  return 0;
...
8010509f:	90                   	nop
    iunlockput(ip);
801050a0:	e8 ab c8 ff ff       	call   80101950 <iunlockput>
    end_op();
...
801050fb:	e8 c0 f4 ff ff       	call   801045c0 <argint>
...
8010512b:	e8 c0 f1 ff ff       	call   801042f0 <memset>
    if(i >= NELEM(argv))
      return -1;
...
80105140:	e8 fb f3 ff ff       	call   80104540 <fetchint>
...
8010515a:	e8 01 f4 ff ff       	call   80104560 <fetchstr>
...
801051e3:	e8 c8 df ff ff       	call   801031b0 <pipealloc>
...
80105264:	e8 57 f3 ff ff       	call   801045c0 <argint>
80105269:	85 c0                	test   %eax,%eax
8010526b:	78 33                	js     801052a0 <sys_shm_open+0x50>
    return -1;

  if(argptr(1, (char **) (&pointer),4)<0)
8010526d:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105270:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
80105277:	00 
80105278:	89 44 24 04          	mov    %eax,0x4(%esp)
8010527c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105283:	e8 78 f3 ff ff       	call   80104600 <argptr>
80105288:	85 c0                	test   %eax,%eax
8010528a:	78 14                	js     801052a0 <sys_shm_open+0x50>
    return -1;
...
80105299:	e8 62 1b 00 00       	call   80106e00 <shm_open>
}
8010529e:	c9                   	leave  
8010529f:	c3                   	ret    
    return -1;
...
801052c4:	e8 f7 f2 ff ff       	call   801045c0 <argint>
801052c9:	85 c0                	test   %eax,%eax
801052cb:	78 13                	js     801052e0 <sys_shm_close+0x30>
    return -1;
...
801052d3:	e8 38 1b 00 00       	call   80106e10 <shm_close>
}
801052d8:	c9                   	leave  
801052d9:	c3                   	ret    
...
801052f3:	5d                   	pop    %ebp
  return fork();
801052f4:	e9 97 e5 ff ff       	jmp    80103890 <fork>
...
80105303:	83 ec 08             	sub    $0x8,%esp
  exit();
80105306:	e8 d5 e7 ff ff       	call   80103ae0 <exit>
...
80105313:	5d                   	pop    %ebp
  return wait();
80105314:	e9 e7 e9 ff ff       	jmp    80103d00 <wait>
...
80105334:	e8 87 f2 ff ff       	call   801045c0 <argint>
...
80105343:	e8 18 eb ff ff       	call   80103e60 <kill>
}
80105348:	c9                   	leave  
80105349:	c3                   	ret    
...
80105363:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105366:	e8 75 e3 ff ff       	call   801036e0 <myproc>
...
80105385:	e8 36 f2 ff ff       	call   801045c0 <argint>
8010538a:	85 c0                	test   %eax,%eax
8010538c:	78 22                	js     801053b0 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
8010538e:	e8 4d e3 ff ff       	call   801036e0 <myproc>
  if(growproc(n) < 0)
...
8010539b:	e8 80 e4 ff ff       	call   80103820 <growproc>
...
801053d5:	e8 e6 f1 ff ff       	call   801045c0 <argint>
801053da:	85 c0                	test   %eax,%eax
801053dc:	78 7e                	js     8010545c <sys_sleep+0x9c>
    return -1;
  acquire(&tickslock);
801053de:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
801053e5:	e8 c6 ed ff ff       	call   801041b0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
801053ea:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
801053ed:	8b 1d a0 56 11 80    	mov    0x801156a0,%ebx
  while(ticks - ticks0 < n){
...
80105400:	c7 44 24 04 60 4e 11 	movl   $0x80114e60,0x4(%esp)
80105407:	80 
80105408:	c7 04 24 a0 56 11 80 	movl   $0x801156a0,(%esp)
8010540f:	e8 3c e8 ff ff       	call   80103c50 <sleep>
  while(ticks - ticks0 < n){
80105414:	a1 a0 56 11 80       	mov    0x801156a0,%eax
80105419:	29 d8                	sub    %ebx,%eax
8010541b:	3b 45 f4             	cmp    -0xc(%ebp),%eax
8010541e:	73 28                	jae    80105448 <sys_sleep+0x88>
    if(myproc()->killed){
80105420:	e8 bb e2 ff ff       	call   801036e0 <myproc>
80105425:	8b 40 24             	mov    0x24(%eax),%eax
80105428:	85 c0                	test   %eax,%eax
8010542a:	74 d4                	je     80105400 <sys_sleep+0x40>
      release(&tickslock);
8010542c:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
80105433:	e8 68 ee ff ff       	call   801042a0 <release>
      return -1;
...
80105444:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  release(&tickslock);
80105448:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
8010544f:	e8 4c ee ff ff       	call   801042a0 <release>
}
...
80105474:	83 ec 14             	sub    $0x14,%esp
  ...
  acquire(&tickslock);
80105477:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
8010547e:	e8 2d ed ff ff       	call   801041b0 <acquire>
  xticks = ticks;
80105483:	8b 1d a0 56 11 80    	mov    0x801156a0,%ebx
  release(&tickslock);
80105489:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
80105490:	e8 0b ee ff ff       	call   801042a0 <release>
  return xticks;
}
...
8010549e:	06                   	push   %es
  pushl %fs
8010549f:	0f a0                	push   %fs
  pushl %gs
801054a1:	0f a8                	push   %gs
  pushal
801054a3:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
801054a4:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
801054a8:	8e d8                	mov    %eax,%ds
  movw %ax, %es
801054aa:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
801054ac:	54                   	push   %esp
  call trap
801054ad:	e8 de 00 00 00       	call   80105590 <trap>
  addl $4, %esp
801054b2:	83 c4 04             	add    $0x4,%esp
...
801054b5:	61                   	popa   
  popl %gs
801054b6:	0f a9                	pop    %gs
  popl %fs
801054b8:	0f a1                	pop    %fs
  popl %es
801054ba:	07                   	pop    %es
  popl %ds
801054bb:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
801054bc:	83 c4 08             	add    $0x8,%esp
  iret
801054bf:	cf                   	iret   
...
801054d4:	66 89 0c c5 a2 4e 11 	mov    %cx,-0x7feeb15e(,%eax,8)
801054db:	80 
801054dc:	c6 04 c5 a4 4e 11 80 	movb   $0x0,-0x7feeb15c(,%eax,8)
801054e3:	00 
801054e4:	c6 04 c5 a5 4e 11 80 	movb   $0x8e,-0x7feeb15b(,%eax,8)
801054eb:	8e 
801054ec:	66 89 14 c5 a0 4e 11 	mov    %dx,-0x7feeb160(,%eax,8)
801054f3:	80 
801054f4:	c1 ea 10             	shr    $0x10,%edx
801054f7:	66 89 14 c5 a6 4e 11 	mov    %dx,-0x7feeb15a(,%eax,8)
801054fe:	80 
  for(i = 0; i < 256; i++)
...
80105519:	c7 44 24 04 c1 75 10 	movl   $0x801075c1,0x4(%esp)
80105520:	80 
80105521:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105528:	66 89 15 a2 50 11 80 	mov    %dx,0x801150a2
8010552f:	66 a3 a0 50 11 80    	mov    %ax,0x801150a0
80105535:	c1 e8 10             	shr    $0x10,%eax
80105538:	c6 05 a4 50 11 80 00 	movb   $0x0,0x801150a4
8010553f:	c6 05 a5 50 11 80 ef 	movb   $0xef,0x801150a5
80105546:	66 a3 a6 50 11 80    	mov    %ax,0x801150a6
  initlock(&tickslock, "time");
8010554c:	e8 6f eb ff ff       	call   801040c0 <initlock>
}
80105551:	c9                   	leave  
80105552:	c3                   	ret    
...
8010556b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010556f:	b8 a0 4e 11 80       	mov    $0x80114ea0,%eax
...
801055b0:	ff 24 85 68 76 10 80 	jmp    *-0x7fef8998(,%eax,4)
801055b7:	90                   	nop
    lapiceoi();
    break;
...
801055b8:	e8 23 e1 ff ff       	call   801036e0 <myproc>
...
801055dc:	e8 df e0 ff ff       	call   801036c0 <cpuid>
...
801055ec:	e8 ef e0 ff ff       	call   801036e0 <myproc>
...
80105623:	c7 04 24 24 76 10 80 	movl   $0x80107624,(%esp)
8010562a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010562e:	e8 1d b0 ff ff       	call   80100650 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
80105633:	e8 a8 e0 ff ff       	call   801036e0 <myproc>
...
80105649:	e8 92 e0 ff ff       	call   801036e0 <myproc>
...
80105655:	e8 86 e0 ff ff       	call   801036e0 <myproc>
8010565a:	85 c0                	test   %eax,%eax
8010565c:	74 0d                	je     8010566b <trap+0xdb>
8010565e:	66 90                	xchg   %ax,%ax
80105660:	e8 7b e0 ff ff       	call   801036e0 <myproc>
...
80105669:	74 4d                	je     801056b8 <trap+0x128>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
8010566b:	e8 70 e0 ff ff       	call   801036e0 <myproc>
80105670:	85 c0                	test   %eax,%eax
80105672:	74 1d                	je     80105691 <trap+0x101>
80105674:	e8 67 e0 ff ff       	call   801036e0 <myproc>
...
801056ab:	75 a8                	jne    80105655 <trap+0xc5>
    exit();
801056ad:	e8 2e e4 ff ff       	call   80103ae0 <exit>
...
80105700:	e8 1b 02 00 00       	call   80105920 <uartintr>
    lapiceoi();
80105705:	e8 b6 d0 ff ff       	call   801027c0 <lapiceoi>
    break;
...
80105717:	e8 a4 df ff ff       	call   801036c0 <cpuid>
8010571c:	c7 04 24 cc 75 10 80 	movl   $0x801075cc,(%esp)
...
8010572f:	e8 1c af ff ff       	call   80100650 <cprintf>
    lapiceoi();
80105734:	e8 87 d0 ff ff       	call   801027c0 <lapiceoi>
    break;
80105739:	e9 02 ff ff ff       	jmp    80105640 <trap+0xb0>
8010573e:	66 90                	xchg   %ax,%ax
    ideintr();
80105740:	e8 7b c9 ff ff       	call   801020c0 <ideintr>
...
8010575a:	75 2c                	jne    80105788 <trap+0x1f8>
    myproc()->tf = tf;
8010575c:	e8 7f df ff ff       	call   801036e0 <myproc>
80105761:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105764:	e8 37 ef ff ff       	call   801046a0 <syscall>
    if(myproc()->killed)
80105769:	e8 72 df ff ff       	call   801036e0 <myproc>
...
8010577f:	5d                   	pop    %ebp
      exit();
80105780:	e9 5b e3 ff ff       	jmp    80103ae0 <exit>
80105785:	8d 76 00             	lea    0x0(%esi),%esi
      exit();
80105788:	e8 53 e3 ff ff       	call   80103ae0 <exit>
8010578d:	eb cd                	jmp    8010575c <trap+0x1cc>
8010578f:	90                   	nop
      acquire(&tickslock);
80105790:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
80105797:	e8 14 ea ff ff       	call   801041b0 <acquire>
      wakeup(&ticks);
8010579c:	c7 04 24 a0 56 11 80 	movl   $0x801156a0,(%esp)
      ticks++;
801057a3:	83 05 a0 56 11 80 01 	addl   $0x1,0x801156a0
      wakeup(&ticks);
801057aa:	e8 41 e6 ff ff       	call   80103df0 <wakeup>
      release(&tickslock);
801057af:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
801057b6:	e8 e5 ea ff ff       	call   801042a0 <release>
801057bb:	e9 1d ff ff ff       	jmp    801056dd <trap+0x14d>
801057c0:	0f 20 d7             	mov    %cr2,%edi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
801057c3:	8b 73 38             	mov    0x38(%ebx),%esi
801057c6:	e8 f5 de ff ff       	call   801036c0 <cpuid>
...
801057da:	c7 04 24 f0 75 10 80 	movl   $0x801075f0,(%esp)
801057e1:	89 44 24 04          	mov    %eax,0x4(%esp)
801057e5:	e8 66 ae ff ff       	call   80100650 <cprintf>
      panic("trap");
801057ea:	c7 04 24 c6 75 10 80 	movl   $0x801075c6,(%esp)
...
80105857:	e8 84 cf ff ff       	call   801027e0 <microdelay>
...
801058e7:	00 
  for(p="xv6...\n"; *p; p++)
801058e8:	bb e8 76 10 80       	mov    $0x801076e8,%ebx
  ioapicenable(IRQ_COM1, 0);
801058ed:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
801058f4:	e8 f7 c9 ff ff       	call   801022f0 <ioapicenable>
  for(p="xv6...\n"; *p; p++)
...
80105936:	6a 00                	push   $0x0
  jmp alltraps
80105938:	e9 60 fb ff ff       	jmp    8010549d <alltraps>
...
8010593f:	6a 01                	push   $0x1
  jmp alltraps
80105941:	e9 57 fb ff ff       	jmp    8010549d <alltraps>
...
80105948:	6a 02                	push   $0x2
  jmp alltraps
8010594a:	e9 4e fb ff ff       	jmp    8010549d <alltraps>
...
80105951:	6a 03                	push   $0x3
  jmp alltraps
80105953:	e9 45 fb ff ff       	jmp    8010549d <alltraps>
...
8010595a:	6a 04                	push   $0x4
  jmp alltraps
8010595c:	e9 3c fb ff ff       	jmp    8010549d <alltraps>
...
80105963:	6a 05                	push   $0x5
  jmp alltraps
80105965:	e9 33 fb ff ff       	jmp    8010549d <alltraps>
...
8010596c:	6a 06                	push   $0x6
  jmp alltraps
8010596e:	e9 2a fb ff ff       	jmp    8010549d <alltraps>
...
80105975:	6a 07                	push   $0x7
  jmp alltraps
80105977:	e9 21 fb ff ff       	jmp    8010549d <alltraps>
...
8010597c:	6a 08                	push   $0x8
  jmp alltraps
8010597e:	e9 1a fb ff ff       	jmp    8010549d <alltraps>
...
80105985:	6a 09                	push   $0x9
  jmp alltraps
80105987:	e9 11 fb ff ff       	jmp    8010549d <alltraps>
...
8010598c:	6a 0a                	push   $0xa
  jmp alltraps
8010598e:	e9 0a fb ff ff       	jmp    8010549d <alltraps>
...
80105993:	6a 0b                	push   $0xb
  jmp alltraps
80105995:	e9 03 fb ff ff       	jmp    8010549d <alltraps>
...
8010599a:	6a 0c                	push   $0xc
  jmp alltraps
8010599c:	e9 fc fa ff ff       	jmp    8010549d <alltraps>
...
801059a1:	6a 0d                	push   $0xd
  jmp alltraps
801059a3:	e9 f5 fa ff ff       	jmp    8010549d <alltraps>
...
801059a8:	6a 0e                	push   $0xe
  jmp alltraps
801059aa:	e9 ee fa ff ff       	jmp    8010549d <alltraps>
...
801059b1:	6a 0f                	push   $0xf
  jmp alltraps
801059b3:	e9 e5 fa ff ff       	jmp    8010549d <alltraps>
...
801059ba:	6a 10                	push   $0x10
  jmp alltraps
801059bc:	e9 dc fa ff ff       	jmp    8010549d <alltraps>
...
801059c1:	6a 11                	push   $0x11
  jmp alltraps
801059c3:	e9 d5 fa ff ff       	jmp    8010549d <alltraps>
...
801059ca:	6a 12                	push   $0x12
  jmp alltraps
801059cc:	e9 cc fa ff ff       	jmp    8010549d <alltraps>
...
801059d3:	6a 13                	push   $0x13
  jmp alltraps
801059d5:	e9 c3 fa ff ff       	jmp    8010549d <alltraps>
...
801059dc:	6a 14                	push   $0x14
  jmp alltraps
801059de:	e9 ba fa ff ff       	jmp    8010549d <alltraps>
...
801059e5:	6a 15                	push   $0x15
  jmp alltraps
801059e7:	e9 b1 fa ff ff       	jmp    8010549d <alltraps>
...
801059ee:	6a 16                	push   $0x16
  jmp alltraps
801059f0:	e9 a8 fa ff ff       	jmp    8010549d <alltraps>
...
801059f7:	6a 17                	push   $0x17
  jmp alltraps
801059f9:	e9 9f fa ff ff       	jmp    8010549d <alltraps>
...
80105a00:	6a 18                	push   $0x18
  jmp alltraps
80105a02:	e9 96 fa ff ff       	jmp    8010549d <alltraps>
...
80105a09:	6a 19                	push   $0x19
  jmp alltraps
80105a0b:	e9 8d fa ff ff       	jmp    8010549d <alltraps>
...
80105a12:	6a 1a                	push   $0x1a
  jmp alltraps
80105a14:	e9 84 fa ff ff       	jmp    8010549d <alltraps>
...
80105a1b:	6a 1b                	push   $0x1b
  jmp alltraps
80105a1d:	e9 7b fa ff ff       	jmp    8010549d <alltraps>
...
80105a24:	6a 1c                	push   $0x1c
  jmp alltraps
80105a26:	e9 72 fa ff ff       	jmp    8010549d <alltraps>
...
80105a2d:	6a 1d                	push   $0x1d
  jmp alltraps
80105a2f:	e9 69 fa ff ff       	jmp    8010549d <alltraps>
...
80105a36:	6a 1e                	push   $0x1e
  jmp alltraps
80105a38:	e9 60 fa ff ff       	jmp    8010549d <alltraps>
...
80105a3f:	6a 1f                	push   $0x1f
  jmp alltraps
80105a41:	e9 57 fa ff ff       	jmp    8010549d <alltraps>
...
80105a48:	6a 20                	push   $0x20
  jmp alltraps
80105a4a:	e9 4e fa ff ff       	jmp    8010549d <alltraps>
...
80105a51:	6a 21                	push   $0x21
  jmp alltraps
80105a53:	e9 45 fa ff ff       	jmp    8010549d <alltraps>
...
80105a5a:	6a 22                	push   $0x22
  jmp alltraps
80105a5c:	e9 3c fa ff ff       	jmp    8010549d <alltraps>
...
80105a63:	6a 23                	push   $0x23
  jmp alltraps
80105a65:	e9 33 fa ff ff       	jmp    8010549d <alltraps>
...
80105a6c:	6a 24                	push   $0x24
  jmp alltraps
80105a6e:	e9 2a fa ff ff       	jmp    8010549d <alltraps>
...
80105a75:	6a 25                	push   $0x25
  jmp alltraps
80105a77:	e9 21 fa ff ff       	jmp    8010549d <alltraps>
...
80105a7e:	6a 26                	push   $0x26
  jmp alltraps
80105a80:	e9 18 fa ff ff       	jmp    8010549d <alltraps>
...
80105a87:	6a 27                	push   $0x27
  jmp alltraps
80105a89:	e9 0f fa ff ff       	jmp    8010549d <alltraps>
...
80105a90:	6a 28                	push   $0x28
  jmp alltraps
80105a92:	e9 06 fa ff ff       	jmp    8010549d <alltraps>
...
80105a99:	6a 29                	push   $0x29
  jmp alltraps
80105a9b:	e9 fd f9 ff ff       	jmp    8010549d <alltraps>
...
80105aa2:	6a 2a                	push   $0x2a
  jmp alltraps
80105aa4:	e9 f4 f9 ff ff       	jmp    8010549d <alltraps>
...
80105aab:	6a 2b                	push   $0x2b
  jmp alltraps
80105aad:	e9 eb f9 ff ff       	jmp    8010549d <alltraps>
...
80105ab4:	6a 2c                	push   $0x2c
  jmp alltraps
80105ab6:	e9 e2 f9 ff ff       	jmp    8010549d <alltraps>
...
80105abd:	6a 2d                	push   $0x2d
  jmp alltraps
80105abf:	e9 d9 f9 ff ff       	jmp    8010549d <alltraps>
...
80105ac6:	6a 2e                	push   $0x2e
  jmp alltraps
80105ac8:	e9 d0 f9 ff ff       	jmp    8010549d <alltraps>
...
80105acf:	6a 2f                	push   $0x2f
  jmp alltraps
80105ad1:	e9 c7 f9 ff ff       	jmp    8010549d <alltraps>
...
80105ad8:	6a 30                	push   $0x30
  jmp alltraps
80105ada:	e9 be f9 ff ff       	jmp    8010549d <alltraps>
...
80105ae1:	6a 31                	push   $0x31
  jmp alltraps
80105ae3:	e9 b5 f9 ff ff       	jmp    8010549d <alltraps>
...
80105aea:	6a 32                	push   $0x32
  jmp alltraps
80105aec:	e9 ac f9 ff ff       	jmp    8010549d <alltraps>
...
80105af3:	6a 33                	push   $0x33
  jmp alltraps
80105af5:	e9 a3 f9 ff ff       	jmp    8010549d <alltraps>
...
80105afc:	6a 34                	push   $0x34
  jmp alltraps
80105afe:	e9 9a f9 ff ff       	jmp    8010549d <alltraps>
...
80105b05:	6a 35                	push   $0x35
  jmp alltraps
80105b07:	e9 91 f9 ff ff       	jmp    8010549d <alltraps>
...
80105b0e:	6a 36                	push   $0x36
  jmp alltraps
80105b10:	e9 88 f9 ff ff       	jmp    8010549d <alltraps>
...
80105b17:	6a 37                	push   $0x37
  jmp alltraps
80105b19:	e9 7f f9 ff ff       	jmp    8010549d <alltraps>
...
80105b20:	6a 38                	push   $0x38
  jmp alltraps
80105b22:	e9 76 f9 ff ff       	jmp    8010549d <alltraps>
...
80105b29:	6a 39                	push   $0x39
  jmp alltraps
80105b2b:	e9 6d f9 ff ff       	jmp    8010549d <alltraps>
...
80105b32:	6a 3a                	push   $0x3a
  jmp alltraps
80105b34:	e9 64 f9 ff ff       	jmp    8010549d <alltraps>
...
80105b3b:	6a 3b                	push   $0x3b
  jmp alltraps
80105b3d:	e9 5b f9 ff ff       	jmp    8010549d <alltraps>
...
80105b44:	6a 3c                	push   $0x3c
  jmp alltraps
80105b46:	e9 52 f9 ff ff       	jmp    8010549d <alltraps>
...
80105b4d:	6a 3d                	push   $0x3d
  jmp alltraps
80105b4f:	e9 49 f9 ff ff       	jmp    8010549d <alltraps>
...
80105b56:	6a 3e                	push   $0x3e
  jmp alltraps
80105b58:	e9 40 f9 ff ff       	jmp    8010549d <alltraps>
...
80105b5f:	6a 3f                	push   $0x3f
  jmp alltraps
80105b61:	e9 37 f9 ff ff       	jmp    8010549d <alltraps>
...
80105b68:	6a 40                	push   $0x40
  jmp alltraps
80105b6a:	e9 2e f9 ff ff       	jmp    8010549d <alltraps>
...
80105b71:	6a 41                	push   $0x41
  jmp alltraps
80105b73:	e9 25 f9 ff ff       	jmp    8010549d <alltraps>
...
80105b7a:	6a 42                	push   $0x42
  jmp alltraps
80105b7c:	e9 1c f9 ff ff       	jmp    8010549d <alltraps>
...
80105b83:	6a 43                	push   $0x43
  jmp alltraps
80105b85:	e9 13 f9 ff ff       	jmp    8010549d <alltraps>
...
80105b8c:	6a 44                	push   $0x44
  jmp alltraps
80105b8e:	e9 0a f9 ff ff       	jmp    8010549d <alltraps>
...
80105b95:	6a 45                	push   $0x45
  jmp alltraps
80105b97:	e9 01 f9 ff ff       	jmp    8010549d <alltraps>
...
80105b9e:	6a 46                	push   $0x46
  jmp alltraps
80105ba0:	e9 f8 f8 ff ff       	jmp    8010549d <alltraps>
...
80105ba7:	6a 47                	push   $0x47
  jmp alltraps
80105ba9:	e9 ef f8 ff ff       	jmp    8010549d <alltraps>
...
80105bb0:	6a 48                	push   $0x48
  jmp alltraps
80105bb2:	e9 e6 f8 ff ff       	jmp    8010549d <alltraps>
...
80105bb9:	6a 49                	push   $0x49
  jmp alltraps
80105bbb:	e9 dd f8 ff ff       	jmp    8010549d <alltraps>
...
80105bc2:	6a 4a                	push   $0x4a
  jmp alltraps
80105bc4:	e9 d4 f8 ff ff       	jmp    8010549d <alltraps>
...
80105bcb:	6a 4b                	push   $0x4b
  jmp alltraps
80105bcd:	e9 cb f8 ff ff       	jmp    8010549d <alltraps>
...
80105bd4:	6a 4c                	push   $0x4c
  jmp alltraps
80105bd6:	e9 c2 f8 ff ff       	jmp    8010549d <alltraps>
...
80105bdd:	6a 4d                	push   $0x4d
  jmp alltraps
80105bdf:	e9 b9 f8 ff ff       	jmp    8010549d <alltraps>
...
80105be6:	6a 4e                	push   $0x4e
  jmp alltraps
80105be8:	e9 b0 f8 ff ff       	jmp    8010549d <alltraps>
...
80105bef:	6a 4f                	push   $0x4f
  jmp alltraps
80105bf1:	e9 a7 f8 ff ff       	jmp    8010549d <alltraps>
...
80105bf8:	6a 50                	push   $0x50
  jmp alltraps
80105bfa:	e9 9e f8 ff ff       	jmp    8010549d <alltraps>
...
80105c01:	6a 51                	push   $0x51
  jmp alltraps
80105c03:	e9 95 f8 ff ff       	jmp    8010549d <alltraps>
...
80105c0a:	6a 52                	push   $0x52
  jmp alltraps
80105c0c:	e9 8c f8 ff ff       	jmp    8010549d <alltraps>
...
80105c13:	6a 53                	push   $0x53
  jmp alltraps
80105c15:	e9 83 f8 ff ff       	jmp    8010549d <alltraps>
...
80105c1c:	6a 54                	push   $0x54
  jmp alltraps
80105c1e:	e9 7a f8 ff ff       	jmp    8010549d <alltraps>
...
80105c25:	6a 55                	push   $0x55
  jmp alltraps
80105c27:	e9 71 f8 ff ff       	jmp    8010549d <alltraps>
...
80105c2e:	6a 56                	push   $0x56
  jmp alltraps
80105c30:	e9 68 f8 ff ff       	jmp    8010549d <alltraps>
...
80105c37:	6a 57                	push   $0x57
  jmp alltraps
80105c39:	e9 5f f8 ff ff       	jmp    8010549d <alltraps>
...
80105c40:	6a 58                	push   $0x58
  jmp alltraps
80105c42:	e9 56 f8 ff ff       	jmp    8010549d <alltraps>
...
80105c49:	6a 59                	push   $0x59
  jmp alltraps
80105c4b:	e9 4d f8 ff ff       	jmp    8010549d <alltraps>
...
80105c52:	6a 5a                	push   $0x5a
  jmp alltraps
80105c54:	e9 44 f8 ff ff       	jmp    8010549d <alltraps>
...
80105c5b:	6a 5b                	push   $0x5b
  jmp alltraps
80105c5d:	e9 3b f8 ff ff       	jmp    8010549d <alltraps>
...
80105c64:	6a 5c                	push   $0x5c
  jmp alltraps
80105c66:	e9 32 f8 ff ff       	jmp    8010549d <alltraps>
...
80105c6d:	6a 5d                	push   $0x5d
  jmp alltraps
80105c6f:	e9 29 f8 ff ff       	jmp    8010549d <alltraps>
...
80105c76:	6a 5e                	push   $0x5e
  jmp alltraps
80105c78:	e9 20 f8 ff ff       	jmp    8010549d <alltraps>
...
80105c7f:	6a 5f                	push   $0x5f
  jmp alltraps
80105c81:	e9 17 f8 ff ff       	jmp    8010549d <alltraps>
...
80105c88:	6a 60                	push   $0x60
  jmp alltraps
80105c8a:	e9 0e f8 ff ff       	jmp    8010549d <alltraps>
...
80105c91:	6a 61                	push   $0x61
  jmp alltraps
80105c93:	e9 05 f8 ff ff       	jmp    8010549d <alltraps>
...
80105c9a:	6a 62                	push   $0x62
  jmp alltraps
80105c9c:	e9 fc f7 ff ff       	jmp    8010549d <alltraps>
...
80105ca3:	6a 63                	push   $0x63
  jmp alltraps
80105ca5:	e9 f3 f7 ff ff       	jmp    8010549d <alltraps>
...
80105cac:	6a 64                	push   $0x64
  jmp alltraps
80105cae:	e9 ea f7 ff ff       	jmp    8010549d <alltraps>
...
80105cb5:	6a 65                	push   $0x65
  jmp alltraps
80105cb7:	e9 e1 f7 ff ff       	jmp    8010549d <alltraps>
...
80105cbe:	6a 66                	push   $0x66
  jmp alltraps
80105cc0:	e9 d8 f7 ff ff       	jmp    8010549d <alltraps>
...
80105cc7:	6a 67                	push   $0x67
  jmp alltraps
80105cc9:	e9 cf f7 ff ff       	jmp    8010549d <alltraps>
...
80105cd0:	6a 68                	push   $0x68
  jmp alltraps
80105cd2:	e9 c6 f7 ff ff       	jmp    8010549d <alltraps>
...
80105cd9:	6a 69                	push   $0x69
  jmp alltraps
80105cdb:	e9 bd f7 ff ff       	jmp    8010549d <alltraps>
...
80105ce2:	6a 6a                	push   $0x6a
  jmp alltraps
80105ce4:	e9 b4 f7 ff ff       	jmp    8010549d <alltraps>
...
80105ceb:	6a 6b                	push   $0x6b
  jmp alltraps
80105ced:	e9 ab f7 ff ff       	jmp    8010549d <alltraps>
...
80105cf4:	6a 6c                	push   $0x6c
  jmp alltraps
80105cf6:	e9 a2 f7 ff ff       	jmp    8010549d <alltraps>
...
80105cfd:	6a 6d                	push   $0x6d
  jmp alltraps
80105cff:	e9 99 f7 ff ff       	jmp    8010549d <alltraps>
...
80105d06:	6a 6e                	push   $0x6e
  jmp alltraps
80105d08:	e9 90 f7 ff ff       	jmp    8010549d <alltraps>
...
80105d0f:	6a 6f                	push   $0x6f
  jmp alltraps
80105d11:	e9 87 f7 ff ff       	jmp    8010549d <alltraps>
...
80105d18:	6a 70                	push   $0x70
  jmp alltraps
80105d1a:	e9 7e f7 ff ff       	jmp    8010549d <alltraps>
...
80105d21:	6a 71                	push   $0x71
  jmp alltraps
80105d23:	e9 75 f7 ff ff       	jmp    8010549d <alltraps>
...
80105d2a:	6a 72                	push   $0x72
  jmp alltraps
80105d2c:	e9 6c f7 ff ff       	jmp    8010549d <alltraps>
...
80105d33:	6a 73                	push   $0x73
  jmp alltraps
80105d35:	e9 63 f7 ff ff       	jmp    8010549d <alltraps>
...
80105d3c:	6a 74                	push   $0x74
  jmp alltraps
80105d3e:	e9 5a f7 ff ff       	jmp    8010549d <alltraps>
...
80105d45:	6a 75                	push   $0x75
  jmp alltraps
80105d47:	e9 51 f7 ff ff       	jmp    8010549d <alltraps>
...
80105d4e:	6a 76                	push   $0x76
  jmp alltraps
80105d50:	e9 48 f7 ff ff       	jmp    8010549d <alltraps>
...
80105d57:	6a 77                	push   $0x77
  jmp alltraps
80105d59:	e9 3f f7 ff ff       	jmp    8010549d <alltraps>
...
80105d60:	6a 78                	push   $0x78
  jmp alltraps
80105d62:	e9 36 f7 ff ff       	jmp    8010549d <alltraps>
...
80105d69:	6a 79                	push   $0x79
  jmp alltraps
80105d6b:	e9 2d f7 ff ff       	jmp    8010549d <alltraps>
...
80105d72:	6a 7a                	push   $0x7a
  jmp alltraps
80105d74:	e9 24 f7 ff ff       	jmp    8010549d <alltraps>
...
80105d7b:	6a 7b                	push   $0x7b
  jmp alltraps
80105d7d:	e9 1b f7 ff ff       	jmp    8010549d <alltraps>
...
80105d84:	6a 7c                	push   $0x7c
  jmp alltraps
80105d86:	e9 12 f7 ff ff       	jmp    8010549d <alltraps>
...
80105d8d:	6a 7d                	push   $0x7d
  jmp alltraps
80105d8f:	e9 09 f7 ff ff       	jmp    8010549d <alltraps>
...
80105d96:	6a 7e                	push   $0x7e
  jmp alltraps
80105d98:	e9 00 f7 ff ff       	jmp    8010549d <alltraps>
...
80105d9f:	6a 7f                	push   $0x7f
  jmp alltraps
80105da1:	e9 f7 f6 ff ff       	jmp    8010549d <alltraps>
...
80105da8:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80105dad:	e9 eb f6 ff ff       	jmp    8010549d <alltraps>
...
80105db4:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80105db9:	e9 df f6 ff ff       	jmp    8010549d <alltraps>
...
80105dc0:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80105dc5:	e9 d3 f6 ff ff       	jmp    8010549d <alltraps>
...
80105dcc:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80105dd1:	e9 c7 f6 ff ff       	jmp    8010549d <alltraps>
...
80105dd8:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80105ddd:	e9 bb f6 ff ff       	jmp    8010549d <alltraps>
...
80105de4:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80105de9:	e9 af f6 ff ff       	jmp    8010549d <alltraps>
...
80105df0:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80105df5:	e9 a3 f6 ff ff       	jmp    8010549d <alltraps>
...
80105dfc:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80105e01:	e9 97 f6 ff ff       	jmp    8010549d <alltraps>
...
80105e08:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80105e0d:	e9 8b f6 ff ff       	jmp    8010549d <alltraps>
...
80105e14:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80105e19:	e9 7f f6 ff ff       	jmp    8010549d <alltraps>
...
80105e20:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80105e25:	e9 73 f6 ff ff       	jmp    8010549d <alltraps>
...
80105e2c:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80105e31:	e9 67 f6 ff ff       	jmp    8010549d <alltraps>
...
80105e38:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80105e3d:	e9 5b f6 ff ff       	jmp    8010549d <alltraps>
...
80105e44:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80105e49:	e9 4f f6 ff ff       	jmp    8010549d <alltraps>
...
80105e50:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80105e55:	e9 43 f6 ff ff       	jmp    8010549d <alltraps>
...
80105e5c:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80105e61:	e9 37 f6 ff ff       	jmp    8010549d <alltraps>
...
80105e68:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80105e6d:	e9 2b f6 ff ff       	jmp    8010549d <alltraps>
...
80105e74:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80105e79:	e9 1f f6 ff ff       	jmp    8010549d <alltraps>
...
80105e80:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80105e85:	e9 13 f6 ff ff       	jmp    8010549d <alltraps>
...
80105e8c:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80105e91:	e9 07 f6 ff ff       	jmp    8010549d <alltraps>
...
80105e98:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80105e9d:	e9 fb f5 ff ff       	jmp    8010549d <alltraps>
...
80105ea4:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80105ea9:	e9 ef f5 ff ff       	jmp    8010549d <alltraps>
...
80105eb0:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80105eb5:	e9 e3 f5 ff ff       	jmp    8010549d <alltraps>
...
80105ebc:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80105ec1:	e9 d7 f5 ff ff       	jmp    8010549d <alltraps>
...
80105ec8:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80105ecd:	e9 cb f5 ff ff       	jmp    8010549d <alltraps>
...
80105ed4:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80105ed9:	e9 bf f5 ff ff       	jmp    8010549d <alltraps>
...
80105ee0:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80105ee5:	e9 b3 f5 ff ff       	jmp    8010549d <alltraps>
...
80105eec:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80105ef1:	e9 a7 f5 ff ff       	jmp    8010549d <alltraps>
...
80105ef8:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80105efd:	e9 9b f5 ff ff       	jmp    8010549d <alltraps>
...
80105f04:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80105f09:	e9 8f f5 ff ff       	jmp    8010549d <alltraps>
...
80105f10:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80105f15:	e9 83 f5 ff ff       	jmp    8010549d <alltraps>
...
80105f1c:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80105f21:	e9 77 f5 ff ff       	jmp    8010549d <alltraps>
...
80105f28:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80105f2d:	e9 6b f5 ff ff       	jmp    8010549d <alltraps>
...
80105f34:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80105f39:	e9 5f f5 ff ff       	jmp    8010549d <alltraps>
...
80105f40:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80105f45:	e9 53 f5 ff ff       	jmp    8010549d <alltraps>
...
80105f4c:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80105f51:	e9 47 f5 ff ff       	jmp    8010549d <alltraps>
...
80105f58:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80105f5d:	e9 3b f5 ff ff       	jmp    8010549d <alltraps>
...
80105f64:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80105f69:	e9 2f f5 ff ff       	jmp    8010549d <alltraps>
...
80105f70:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80105f75:	e9 23 f5 ff ff       	jmp    8010549d <alltraps>
...
80105f7c:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80105f81:	e9 17 f5 ff ff       	jmp    8010549d <alltraps>
...
80105f88:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80105f8d:	e9 0b f5 ff ff       	jmp    8010549d <alltraps>
...
80105f94:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80105f99:	e9 ff f4 ff ff       	jmp    8010549d <alltraps>
...
80105fa0:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80105fa5:	e9 f3 f4 ff ff       	jmp    8010549d <alltraps>
...
80105fac:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80105fb1:	e9 e7 f4 ff ff       	jmp    8010549d <alltraps>
...
80105fb8:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80105fbd:	e9 db f4 ff ff       	jmp    8010549d <alltraps>
...
80105fc4:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80105fc9:	e9 cf f4 ff ff       	jmp    8010549d <alltraps>
...
80105fd0:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80105fd5:	e9 c3 f4 ff ff       	jmp    8010549d <alltraps>
...
80105fdc:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80105fe1:	e9 b7 f4 ff ff       	jmp    8010549d <alltraps>
...
80105fe8:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80105fed:	e9 ab f4 ff ff       	jmp    8010549d <alltraps>
...
80105ff4:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80105ff9:	e9 9f f4 ff ff       	jmp    8010549d <alltraps>
...
80106000:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106005:	e9 93 f4 ff ff       	jmp    8010549d <alltraps>
...
8010600c:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106011:	e9 87 f4 ff ff       	jmp    8010549d <alltraps>
...
80106018:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010601d:	e9 7b f4 ff ff       	jmp    8010549d <alltraps>
...
80106024:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80106029:	e9 6f f4 ff ff       	jmp    8010549d <alltraps>
...
80106030:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106035:	e9 63 f4 ff ff       	jmp    8010549d <alltraps>
...
8010603c:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106041:	e9 57 f4 ff ff       	jmp    8010549d <alltraps>
...
80106048:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010604d:	e9 4b f4 ff ff       	jmp    8010549d <alltraps>
...
80106054:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80106059:	e9 3f f4 ff ff       	jmp    8010549d <alltraps>
...
80106060:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106065:	e9 33 f4 ff ff       	jmp    8010549d <alltraps>
...
8010606c:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106071:	e9 27 f4 ff ff       	jmp    8010549d <alltraps>
...
80106078:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010607d:	e9 1b f4 ff ff       	jmp    8010549d <alltraps>
...
80106084:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80106089:	e9 0f f4 ff ff       	jmp    8010549d <alltraps>
...
80106090:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106095:	e9 03 f4 ff ff       	jmp    8010549d <alltraps>
...
8010609c:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801060a1:	e9 f7 f3 ff ff       	jmp    8010549d <alltraps>
...
801060a8:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801060ad:	e9 eb f3 ff ff       	jmp    8010549d <alltraps>
...
801060b4:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801060b9:	e9 df f3 ff ff       	jmp    8010549d <alltraps>
...
801060c0:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801060c5:	e9 d3 f3 ff ff       	jmp    8010549d <alltraps>
...
801060cc:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801060d1:	e9 c7 f3 ff ff       	jmp    8010549d <alltraps>
...
801060d8:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801060dd:	e9 bb f3 ff ff       	jmp    8010549d <alltraps>
...
801060e4:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801060e9:	e9 af f3 ff ff       	jmp    8010549d <alltraps>
...
801060f0:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801060f5:	e9 a3 f3 ff ff       	jmp    8010549d <alltraps>
...
801060fc:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106101:	e9 97 f3 ff ff       	jmp    8010549d <alltraps>
...
80106108:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010610d:	e9 8b f3 ff ff       	jmp    8010549d <alltraps>
...
80106114:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80106119:	e9 7f f3 ff ff       	jmp    8010549d <alltraps>
...
80106120:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106125:	e9 73 f3 ff ff       	jmp    8010549d <alltraps>
...
8010612c:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106131:	e9 67 f3 ff ff       	jmp    8010549d <alltraps>
...
80106138:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010613d:	e9 5b f3 ff ff       	jmp    8010549d <alltraps>
...
80106144:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80106149:	e9 4f f3 ff ff       	jmp    8010549d <alltraps>
...
80106150:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106155:	e9 43 f3 ff ff       	jmp    8010549d <alltraps>
...
8010615c:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106161:	e9 37 f3 ff ff       	jmp    8010549d <alltraps>
...
80106168:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010616d:	e9 2b f3 ff ff       	jmp    8010549d <alltraps>
...
80106174:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80106179:	e9 1f f3 ff ff       	jmp    8010549d <alltraps>
...
80106180:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106185:	e9 13 f3 ff ff       	jmp    8010549d <alltraps>
...
8010618c:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106191:	e9 07 f3 ff ff       	jmp    8010549d <alltraps>
...
80106198:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010619d:	e9 fb f2 ff ff       	jmp    8010549d <alltraps>
...
801061a4:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801061a9:	e9 ef f2 ff ff       	jmp    8010549d <alltraps>
...
801061b0:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801061b5:	e9 e3 f2 ff ff       	jmp    8010549d <alltraps>
...
801061bc:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801061c1:	e9 d7 f2 ff ff       	jmp    8010549d <alltraps>
...
801061c8:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801061cd:	e9 cb f2 ff ff       	jmp    8010549d <alltraps>
...
801061d4:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801061d9:	e9 bf f2 ff ff       	jmp    8010549d <alltraps>
...
801061e0:	68 da 00 00 00       	push   $0xda
  jmp alltraps
801061e5:	e9 b3 f2 ff ff       	jmp    8010549d <alltraps>
...
801061ec:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
801061f1:	e9 a7 f2 ff ff       	jmp    8010549d <alltraps>
...
801061f8:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
801061fd:	e9 9b f2 ff ff       	jmp    8010549d <alltraps>
...
80106204:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80106209:	e9 8f f2 ff ff       	jmp    8010549d <alltraps>
...
80106210:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106215:	e9 83 f2 ff ff       	jmp    8010549d <alltraps>
...
8010621c:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106221:	e9 77 f2 ff ff       	jmp    8010549d <alltraps>
...
80106228:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010622d:	e9 6b f2 ff ff       	jmp    8010549d <alltraps>
...
80106234:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80106239:	e9 5f f2 ff ff       	jmp    8010549d <alltraps>
...
80106240:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106245:	e9 53 f2 ff ff       	jmp    8010549d <alltraps>
...
8010624c:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106251:	e9 47 f2 ff ff       	jmp    8010549d <alltraps>
...
80106258:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010625d:	e9 3b f2 ff ff       	jmp    8010549d <alltraps>
...
80106264:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80106269:	e9 2f f2 ff ff       	jmp    8010549d <alltraps>
...
80106270:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106275:	e9 23 f2 ff ff       	jmp    8010549d <alltraps>
...
8010627c:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106281:	e9 17 f2 ff ff       	jmp    8010549d <alltraps>
...
80106288:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010628d:	e9 0b f2 ff ff       	jmp    8010549d <alltraps>
...
80106294:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80106299:	e9 ff f1 ff ff       	jmp    8010549d <alltraps>
...
801062a0:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801062a5:	e9 f3 f1 ff ff       	jmp    8010549d <alltraps>
...
801062ac:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801062b1:	e9 e7 f1 ff ff       	jmp    8010549d <alltraps>
...
801062b8:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801062bd:	e9 db f1 ff ff       	jmp    8010549d <alltraps>
...
801062c4:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801062c9:	e9 cf f1 ff ff       	jmp    8010549d <alltraps>
...
801062d0:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801062d5:	e9 c3 f1 ff ff       	jmp    8010549d <alltraps>
...
801062dc:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
801062e1:	e9 b7 f1 ff ff       	jmp    8010549d <alltraps>
...
801062e8:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
801062ed:	e9 ab f1 ff ff       	jmp    8010549d <alltraps>
...
801062f4:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
801062f9:	e9 9f f1 ff ff       	jmp    8010549d <alltraps>
...
80106300:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106305:	e9 93 f1 ff ff       	jmp    8010549d <alltraps>
...
8010630c:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106311:	e9 87 f1 ff ff       	jmp    8010549d <alltraps>
...
80106318:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010631d:	e9 7b f1 ff ff       	jmp    8010549d <alltraps>
...
80106324:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80106329:	e9 6f f1 ff ff       	jmp    8010549d <alltraps>
...
80106330:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106335:	e9 63 f1 ff ff       	jmp    8010549d <alltraps>
...
8010633c:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106341:	e9 57 f1 ff ff       	jmp    8010549d <alltraps>
...
80106348:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010634d:	e9 4b f1 ff ff       	jmp    8010549d <alltraps>
...
80106354:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80106359:	e9 3f f1 ff ff       	jmp    8010549d <alltraps>
...
80106360:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106365:	e9 33 f1 ff ff       	jmp    8010549d <alltraps>
...
8010636c:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106371:	e9 27 f1 ff ff       	jmp    8010549d <alltraps>
...
80106378:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010637d:	e9 1b f1 ff ff       	jmp    8010549d <alltraps>
...
80106384:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80106389:	e9 0f f1 ff ff       	jmp    8010549d <alltraps>
...
80106390:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106395:	e9 03 f1 ff ff       	jmp    8010549d <alltraps>
...
8010639c:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801063a1:	e9 f7 f0 ff ff       	jmp    8010549d <alltraps>
...
801063f4:	e8 e7 c0 ff ff       	call   801024e0 <kalloc>
...
80106412:	e8 d9 de ff ff       	call   801042f0 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106483:	e8 a8 be ff ff       	call   80102330 <kfree>
      *pte = 0;
...
801064ca:	c3                   	ret    
        panic("kfree");
801064cb:	c7 04 24 86 70 10 80 	movl   $0x80107086,(%esp)
...
801064e3:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
801064e6:	e8 d5 d1 ff ff       	call   801036c0 <cpuid>
...
80106620:	a1 a4 56 11 80       	mov    0x801156a4,%eax
{
...
80106664:	0f 84 c3 00 00 00    	je     8010672d <switchuvm+0xed>
  pushcli();
8010666a:	e8 01 db ff ff       	call   80104170 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
8010666f:	e8 cc cf ff ff       	call   80103640 <mycpu>
80106674:	89 c3                	mov    %eax,%ebx
80106676:	e8 c5 cf ff ff       	call   80103640 <mycpu>
8010667b:	89 c7                	mov    %eax,%edi
8010667d:	e8 be cf ff ff       	call   80103640 <mycpu>
80106682:	83 c7 08             	add    $0x8,%edi
80106685:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106688:	e8 b3 cf ff ff       	call   80103640 <mycpu>
...
8010671b:	5d                   	pop    %ebp
  popcli();
8010671c:	e9 0f db ff ff       	jmp    80104230 <popcli>
    panic("switchuvm: no process");
80106721:	c7 04 24 f6 76 10 80 	movl   $0x801076f6,(%esp)
80106728:	e8 33 9c ff ff       	call   80100360 <panic>
    panic("switchuvm: no pgdir");
8010672d:	c7 04 24 21 77 10 80 	movl   $0x80107721,(%esp)
80106734:	e8 27 9c ff ff       	call   80100360 <panic>
    panic("switchuvm: no kstack");
80106739:	c7 04 24 0c 77 10 80 	movl   $0x8010770c,(%esp)
...
8010676a:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  mem = kalloc();
8010676d:	e8 6e bd ff ff       	call   801024e0 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106785:	89 c3                	mov    %eax,%ebx
  memset(mem, 0, PGSIZE);
80106787:	e8 64 db ff ff       	call   801042f0 <memset>
...
801067c8:	5d                   	pop    %ebp
  memmove(mem, init, sz);
801067c9:	e9 c2 db ff ff       	jmp    80104390 <memmove>
    panic("inituvm: more than a page");
801067ce:	c7 04 24 35 77 10 80 	movl   $0x80107735,(%esp)
...
8010685d:	e8 3e b1 ff ff       	call   801019a0 <readi>
...
80106882:	c7 04 24 4f 77 10 80 	movl   $0x8010774f,(%esp)
80106889:	e8 d2 9a ff ff       	call   80100360 <panic>
    panic("loaduvm: addr must be page aligned");
8010688e:	c7 04 24 f0 77 10 80 	movl   $0x801077f0,(%esp)
...
801068eb:	e8 00 da ff ff       	call   801042f0 <memset>
...
80106925:	76 29                	jbe    80106950 <allocuvm+0xb0>
    mem = kalloc();
80106927:	e8 b4 bb ff ff       	call   801024e0 <kalloc>
    if(mem == 0){
...
80106932:	c7 04 24 6d 77 10 80 	movl   $0x8010776d,(%esp)
...
80106960:	c7 04 24 85 77 10 80 	movl   $0x80107785,(%esp)
...
80106981:	e8 aa b9 ff ff       	call   80102330 <kfree>
      return 0;
...
80106a0d:	e8 1e b9 ff ff       	call   80102330 <kfree>
  for(i = 0; i < NPDENTRIES; i++){
...
80106a22:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80106a23:	e9 08 b9 ff ff       	jmp    80102330 <kfree>
    panic("freevm: no pgdir");
80106a28:	c7 04 24 a1 77 10 80 	movl   $0x801077a1,(%esp)
...
80106a48:	e8 93 ba ff ff       	call   801024e0 <kalloc>
...
80106a6b:	e8 80 d8 ff ff       	call   801042f0 <memset>
...
80106adb:	a3 a4 56 11 80       	mov    %eax,0x801156a4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106b0b:	c3                   	ret    
    panic("clearpteu");
80106b0c:	c7 04 24 b2 77 10 80 	movl   $0x801077b2,(%esp)
...
80106b33:	0f 84 6d 01 00 00    	je     80106ca6 <copyuvm+0x186>
    return 0;
...
80106b5d:	e8 2e d8 ff ff       	call   80104390 <memmove>
...
80106ba7:	0f 84 0c 01 00 00    	je     80106cb9 <copyuvm+0x199>
    if(!(*pte & PTE_P))
80106bad:	8b 30                	mov    (%eax),%esi
80106baf:	f7 c6 01 00 00 00    	test   $0x1,%esi
80106bb5:	0f 84 f2 00 00 00    	je     80106cad <copyuvm+0x18d>
    pa = PTE_ADDR(*pte);
...
80106bc6:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80106bcc:	e8 0f b9 ff ff       	call   801024e0 <kalloc>
...
80106bf0:	8b 5d 10             	mov    0x10(%ebp),%ebx
80106bf3:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
80106bf9:	81 fb fb ff ff 7f    	cmp    $0x7ffffffb,%ebx
80106bff:	76 5b                	jbe    80106c5c <copyuvm+0x13c>
80106c01:	e9 95 00 00 00       	jmp    80106c9b <copyuvm+0x17b>
...
80106c1d:	e8 6e d7 ff ff       	call   80104390 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0)
80106c22:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106c25:	8d 96 00 00 00 80    	lea    -0x80000000(%esi),%edx
80106c2b:	89 54 24 0c          	mov    %edx,0xc(%esp)
80106c2f:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106c36:	00 
80106c37:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80106c3b:	89 44 24 10          	mov    %eax,0x10(%esp)
80106c3f:	8b 45 e0             	mov    -0x20(%ebp),%eax
...
80106c54:	81 fb fb ff ff 7f    	cmp    $0x7ffffffb,%ebx
80106c5a:	77 3f                	ja     80106c9b <copyuvm+0x17b>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106c5c:	8b 45 08             	mov    0x8(%ebp),%eax
80106c5f:	31 c9                	xor    %ecx,%ecx
80106c61:	89 da                	mov    %ebx,%edx
80106c63:	e8 48 f7 ff ff       	call   801063b0 <walkpgdir>
80106c68:	85 c0                	test   %eax,%eax
80106c6a:	74 4d                	je     80106cb9 <copyuvm+0x199>
    if(!(*pte & PTE_P))
80106c6c:	8b 30                	mov    (%eax),%esi
80106c6e:	f7 c6 01 00 00 00    	test   $0x1,%esi
80106c74:	74 37                	je     80106cad <copyuvm+0x18d>
    pa = PTE_ADDR(*pte);
80106c76:	89 f7                	mov    %esi,%edi
    flags = PTE_FLAGS(*pte);
80106c78:	81 e6 ff 0f 00 00    	and    $0xfff,%esi
80106c7e:	89 75 e4             	mov    %esi,-0x1c(%ebp)
    pa = PTE_ADDR(*pte);
80106c81:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80106c87:	e8 54 b8 ff ff       	call   801024e0 <kalloc>
80106c8c:	85 c0                	test   %eax,%eax
80106c8e:	89 c6                	mov    %eax,%esi
80106c90:	0f 85 72 ff ff ff    	jne    80106c08 <copyuvm+0xe8>
80106c96:	e9 40 ff ff ff       	jmp    80106bdb <copyuvm+0xbb>
...
80106ca8:	e9 3b ff ff ff       	jmp    80106be8 <copyuvm+0xc8>
      panic("copyuvm: page not present");
80106cad:	c7 04 24 d6 77 10 80 	movl   $0x801077d6,(%esp)
80106cb4:	e8 a7 96 ff ff       	call   80100360 <panic>
      panic("copyuvm: pte should exist");
80106cb9:	c7 04 24 bc 77 10 80 	movl   $0x801077bc,(%esp)
80106cc0:	e8 9b 96 ff ff       	call   80100360 <panic>
80106cc5:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
...
80106d4c:	e8 3f d6 ff ff       	call   80104390 <memmove>
    len -= n;
    buf += n;
...
80106da6:	c7 44 24 04 14 78 10 	movl   $0x80107814,0x4(%esp)
80106dad:	80 
80106dae:	c7 04 24 c0 56 11 80 	movl   $0x801156c0,(%esp)
80106db5:	e8 06 d3 ff ff       	call   801040c0 <initlock>
  acquire(&(shm_table.lock));
80106dba:	c7 04 24 c0 56 11 80 	movl   $0x801156c0,(%esp)
80106dc1:	e8 ea d3 ff ff       	call   801041b0 <acquire>
80106dc6:	b8 f4 56 11 80       	mov    $0x801156f4,%eax
80106dcb:	90                   	nop
...
80106de0:	c7 40 fc 00 00 00 00 	movl   $0x0,-0x4(%eax)
  for (i = 0; i< 64; i++) {
80106de7:	3d f4 59 11 80       	cmp    $0x801159f4,%eax
80106dec:	75 e2                	jne    80106dd0 <shminit+0x30>
  }
  release(&(shm_table.lock));
80106dee:	c7 04 24 c0 56 11 80 	movl   $0x801156c0,(%esp)
80106df5:	e8 a6 d4 ff ff       	call   801042a0 <release>
}
80106dfa:	c9                   	leave  
80106dfb:	c3                   	ret    
